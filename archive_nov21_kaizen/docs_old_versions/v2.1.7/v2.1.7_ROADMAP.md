...
2. **Three Layers**: Scratch (ephemeral) → Working (active) → Archive (long-term)
...
╭─ WhiteMagic Setup Wizard (1/4) ───────────────────╮
│ Welcome! How will you use WhiteMagic?             │
│                                                    │
│ [ ] Personal AI Companion                         │
│     Journaling, planning, creativity              │
│                                                    │
│ [ ] Development & Freelance Work                  │
│     Project memory, code context                  │
│                                                    │
│ [ ] Team Collaboration                            │
│     Shared knowledge, onboarding                  │
│                                                    │
│ [ ] Regulated Domain (Medical/Legal/Gov)          │
│     Per-case isolation, audit trails              │
│                                                    │
│ [Continue]                                         │
╰────────────────────────────────────────────────────╯

╭─ WhiteMagic Setup Wizard (2/4) ───────────────────╮
│ AI & Search Configuration                         │
│                                                    │
│ Current: Minimal (~50MB)                          │
│ ✅ Core memory, config, CLI                       │
│                                                    │
│ Add Local AI? (+2.5GB)                            │
│ [ ] Yes - Privacy-first, works offline           │
│ [ ] No - I'll use OpenAI API (requires key)      │
│                                                    │
│ [Continue] [Back]                                  │
╰────────────────────────────────────────────────────╯
```
...
Content: [paste]
Suggested tags: terminal, bugfix, v2.2.1, security
Accept? [Y/n/edit]: 
```
