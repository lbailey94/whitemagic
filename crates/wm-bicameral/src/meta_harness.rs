...
impl ModeStats {
    ...
    pub const fn avg_latency_us(&self) -> u64 {
        // const fn: checked_div/unwrap_or is not const-callable yet.
...
mod tests {
    ...
    fn stats_track_by_mode() {
        ...
        // avg_latency_us() is integer-divided; sub-microsecond calls on fast
        // machines (Apple Silicon CI) legitimately round to 0 — do not assert
        // a strictly positive average.
    }
