...
fn row_to_v2_memory(row: &Row) -> rusqlite::Result<V2Memory> {
    Ok(V2Memory {
        ...
        is_protected: row.get::<_, i64>("is_protected").is_ok_and(|v| v != 0),
        is_private: row.get::<_, i64>("is_private").is_ok_and(|v| v != 0),
        model_exclude: row.get::<_, i64>("model_exclude").is_ok_and(|v| v != 0),
