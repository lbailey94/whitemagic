...
use crate::resonance::bus::ResonanceEvent;
use crate::resonance::event_type::EventType;
use crate::resonance::nervous_system::NervousSubsystem;
...
impl Synchronicity {
    ...
    pub fn strength(&self) -> f32 {
        ...
        salience_factor
            .mul_add(0.4, subsystem_factor * 0.6)
            .clamp(0.0, 1.0)
    }
}
...
/// # Example
/// ```no_run
/// use wm_cognitive::{SynchronicityDetector, ResonanceEvent, EventType};
///
