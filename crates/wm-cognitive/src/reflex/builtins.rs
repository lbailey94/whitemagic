...
use crate::reflex::dispatch::ReflexHandler;
use crate::reflex::safety::SafetyBit;
use crate::reflex::types::{ReflexArgs, ReflexCommand, ReflexError, ReflexId, ReflexOutput};
...
pub fn register_builtins(table: &mut crate::reflex::ReflexDispatchTable) {
...
mod tests {
    use super::*;
    use crate::reflex::dispatch::ReflexDispatchTable;
    #[test]
