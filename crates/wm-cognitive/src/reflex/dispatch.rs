...
use crate::reflex::safety::{SAFETY_DEFAULT, SafetyBit, is_allowed};
use crate::reflex::types::{ReflexArgs, ReflexError, ReflexId, ReflexOutput, SafetyMask};
...
impl ReflexDispatchTable {
    ...
    pub fn permissive() -> Self {
        Self::new(crate::reflex::safety::SAFETY_ALLOW_ALL)
    }
...
mod tests {
    use super::*;
    use crate::reflex::types::{ReflexCommand, ReflexOutput};
