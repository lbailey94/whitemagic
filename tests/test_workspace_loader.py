...
class TestWorkspaceLoader:
    ...
    def test_additional_paths(self, workspace_root):
        ...
        context = loader.load_for_task("Test task", tier=0, additional_paths=["special"])
...
class TestConvenienceFunction:
    ...
    def test_load_workspace_for_task(self, workspace_root):
        ...
        context = load_workspace_for_task(str(workspace_root), "Implement new feature", tier=0)
    ...
    def test_load_with_additional_paths(self, workspace_root):
        ...
        context = load_workspace_for_task(
            str(workspace_root), "Test task", tier=0, additional_paths=["custom"]
        )
...
class TestDirectoryInfo:
    ...
    def test_directory_info_defaults(self):
        ...
        info = DirectoryInfo(path=Path("/test"), name="test", file_count=0, subdirs=[])
