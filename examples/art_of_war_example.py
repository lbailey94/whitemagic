...
def example_threading_tiers():
    ...
    print(f"Simple task: Tier {recommend_tier('simple')} ({get_tier_threads(recommend_tier('simple'))} threads)")
    print(f"Moderate task: Tier {recommend_tier('moderate')} ({get_tier_threads(recommend_tier('moderate'))} threads)")
    print(f"Complex task: Tier {recommend_tier('complex')} ({get_tier_threads(recommend_tier('complex'))} threads)")
