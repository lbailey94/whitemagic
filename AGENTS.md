...
## Architecture (15 crates, 203 tools, ~131,000 LOC, 3,332 tests)
...
The MCP server exposes a **single tool** (`wm`) via `tools/list`. All 203 tools are accessible through the `wm` meta-tool:
