...
## Architecture (15 crates, 199 tools, ~131,000 LOC, 3,284 tests)
...
The MCP server exposes a **single tool** (`wm`) via `tools/list`. All 199 tools are accessible through the `wm` meta-tool:
