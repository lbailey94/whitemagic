...
## Architecture (15 crates, 208 tools, ~131,000 LOC, 3,345 tests)
...
The MCP server exposes a **single tool** (`wm`) via `tools/list`. All 208 tools are accessible through the `wm` meta-tool:
