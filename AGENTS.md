...
## Architecture (15 crates, 202 tools, ~131,000 LOC, 3,311 tests)
...
The MCP server exposes a **single tool** (`wm`) via `tools/list`. All 202 tools are accessible through the `wm` meta-tool:
