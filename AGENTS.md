...
## Architecture (15 crates, 204 tools, ~131,000 LOC, 3,335 tests)
...
The MCP server exposes a **single tool** (`wm`) via `tools/list`. All 204 tools are accessible through the `wm` meta-tool:
