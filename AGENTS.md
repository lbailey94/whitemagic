...
cargo test                     # Run all tests (3,168 tests)
...
## Architecture (14 crates, 184 tools, ~128,500 LOC, 3,168 tests)
...
The MCP server exposes a **single tool** (`wm`) via `tools/list`. All 184 tools are accessible through the `wm` meta-tool:
