...
- **Office Hours** — $1,000 / 60-minute session. One specific question: deployment decision, governance risk, MCP architecture review. Written notes within 48 hours. Stripe payment link available on /pricing. Office Hours fee credits toward future engagements.

- **Architecture Review** — $12,000 flat, 5-day turnaround. 20-40 page written deliverable. Risks mapped to OWASP LLM Top 10 (v1.1, covers agentic AI) and EU AI Act Article 14. One 60-minute walkthrough call. NDA on request. Stripe payment link available.

- **Engagement** — From $35,000. 4-8 week fixed-scope implementations on one of the three service tracks. Weekly delivery cadence. 50% on kickoff, 50% on delivery. Limited to 2 concurrent engagements. Scoped via free 30-minute intake call at /contact.
