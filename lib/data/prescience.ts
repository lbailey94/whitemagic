...
export const PRESCIENCE_CLAIMS: Claim[] = [
  { icon: Clock, claim: "AI SBOM / Transparency Ledger — cryptographic model lineage tracking", when: "Jun 12, 2025", validated: "May 1, 2026", gap: "~50 weeks", detail: "Specified cryptographic model lineage tracking and AI software bill of materials. OpenTelemetry GenAI semantic conventions standardized the same concept ~50 weeks later. Independently verifiable: CODEX OpenAI archive ID 684b6aa4-f83c-8005-a005-cab4d70b1f69, server-timestamped 2025-06-12." },
...
export const PRESCIENCE_PENDING: PendingClaim[] = [
  ...
  {
    claim: "Time Dilation Bias in AI Agents — AI systematically overestimates task duration by 3-5x",
    when: "Jul 2026",
    direction: "Documented across 4+ cases in WhiteMagic session analysis: tool registry definitions estimated 30 min, took 3 min; Rust PyO3 bindings estimated 'infrastructure setup,' took 5 min; 19 E2E pipeline tests estimated 20 min, took 2 min. This is a cognitive bias, not a calibration problem. No industry research has identified this bias yet.",
    status: "pending",
    confidence: "high",
    source: "WhiteMagic Session #1 (9433f859), AGENTS.md §12 — Time Dilation Bias",
  },
  {
    claim: "Per-Galaxy Memory Isolation — corruption containment via database sharding",
    when: "Jul 2026",
    direction: "WhiteMagic v24 implements per-galaxy SQLite databases (11 galaxies) to isolate corruption risk. Most AI memory systems use monolithic storage — a single corruption event compromises all memories. Per-galaxy isolation contains corruption to a single galaxy.",
    status: "pending",
    confidence: "medium",
    source: "WhiteMagic v24 roadmap, database corruption investigation",
  },
  {
    claim: "Tri-Layer Dispatch Pipeline (Zig/Python/Koka) — multi-language tool dispatch",
    when: "Jun 2026",
    direction: "Pre-check in Zig (FFI), middleware in Python, effect tracking in Koka. Most AI tool systems use single-language dispatch. No industry equivalent exists. The tri-layer approach enables compile-time safety checks, runtime flexibility, and effect-system verification in one pipeline.",
    status: "pending",
    confidence: "medium",
    source: "WhiteMagic Session #3 (0e2cc745) — full project history deep dive",
  },
  {
    claim: "Engine-Gana-Garden Triadic Symmetry — cognitive architecture with natural correspondences",
    when: "Jun 2026",
    direction: "28 engines map 1:1 to 28 Ganas (Lunar Mansions) map 1:1 to 28 Gardens (emotional subsystems). This triadic symmetry is unique to WhiteMagic. No other AI system uses triadic structural correspondence — most use arbitrary divisions or single-axis taxonomies.",
    status: "pending",
    confidence: "medium",
    source: "WhiteMagic Session #9 (2f553828) — engine consolidation",
  },
  {
    claim: "Coherence-Aware Governance — safety thresholds adjusted by internal coherence measurement",
    when: "Jun 2026",
    direction: "When WhiteMagic's internal coherence measurement is low (confused, uncertain, overloaded), the governor automatically becomes more conservative — lowering thresholds for blocking risky tools, requiring more validation. No other AI governance system uses self-awareness for safety gating.",
    status: "pending",
    confidence: "medium",
    source: "WhiteMagic Session #15 (ce51f277) — coherence-aware governor middleware",
  },
  {
    claim: "Archaeological Development Method — active recovery of lost architecture from archived versions",
    when: "Jun 2026",
    direction: "Treat past versions as archaeological sites. Unique features, patterns, and code that exist only in archives are excavated, surfaced, and integrated into the current version. 19 major architectural patterns were recovered this way. No other AI project uses archaeological recovery as a development methodology.",
    status: "pending",
    confidence: "medium",
    source: "WhiteMagic Session #14 (9f057a1b) — archive evolution map",
  },
  {
    claim: "Alchemical Loop Cognitive Cycle — 9-phase yang/yin alternating analysis-synthesis",
    when: "Jun 2026",
    direction: "A 9-phase cognitive cycle where yang (active/analytical) output feeds into yin (receptive/synthetic) input, with oracle-driven strategy selection. This is a computational pattern for alternating between analysis and synthesis. No equivalent exists in AI cognitive architectures.",
    status: "pending",
    confidence: "medium",
    source: "WhiteMagic Session #18 (c195b4ce) — alchemical loop output→input chaining",
  },
];
