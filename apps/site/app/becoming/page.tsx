  ...
  return (
    <main className="container-site py-16">
      ...
      <section className="mb-12 rounded-2xl border border-border bg-surface p-6">
        ...
        <Link
          href="/becoming/0"
          className="mt-3 inline-block rounded-lg border border-border bg-surface-alt px-4 py-2 font-mono text-sm text-ink transition hover:border-lavender"
        >
          Read the Prologue
        </Link>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 max-w-prose text-muted">
          Rows are the eight sections — Civilizational Design through First
          Contact & Cosmos. Columns follow the King Wen sequence. Each cell is a
          chapter. Published chapters glow. The board fills in over time.
        </p>
        <BecomingBoard />
      </section>
