...
const FIRMS: FirmRow[] = [
  { name: "WhiteMagic Labs (solo, $0 budget)", avgLead: "~25.3 wks", resources: "Personal hardware + free AI APIs", crossDomain: true, score: "380+", highlight: true },
...
const STATS = [
  { icon: Award, label: "Prescience score", value: "380+", sub: "1 point per validated week of lead time" },
  { icon: Clock, label: "Avg lead time", value: "25.3 wks", sub: "per validated claim" },
  { icon: TrendingUp, label: "Validated claims", value: "15", sub: "with independently verifiable sources" },
      ...
      <div className="container-site mx-auto max-w-4xl space-y-12">
        ...
        <div>
          <p className="mb-2 font-mono text-xs uppercase tracking-widest text-lavender">
            Prescience score · updated May 26, 2026
          </p>
