...
export const PRICING_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "Because the best CTO engagements start with someone inside the company doing their own diligence first. A $700 session beats a $50K mistake. If you later bring me in for a real engagement, the Office Hours fee gets credited to the scope.",
  },
  {
