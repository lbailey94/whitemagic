...
**Status**: v5.3.0 — 15 crates, 195 tools, 3,240 tests, ~131,000 LOC, 0 clippy warnings, 0 dependency vulnerabilities, 0 lock panics in production code. Conformal prediction shipped as a net-new feature (2026-08-08). Boundary hardening (2026-08-08).
