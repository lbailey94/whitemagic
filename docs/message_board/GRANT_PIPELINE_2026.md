...
**Target Regrantors:**
| Regrantor | Focus | Proposed Ask |
|---|---|---|
| Joel Becker | AI safety infrastructure | $25K — Karma Ledger benchmark on 100+ tool interactions |
| Neel Nanda | Interpretability | $15K — Voice Audit for tool-selection hallucination detection |
| Gavin Leech | Forecasting / epistemics | $10K — Foresight Engine drift prediction validation |

**Blockers:**
- ❌ No Manifund account
- ❌ Project pages not drafted
...
## 2. Deferred Opportunities (Apply Later)

### 2.1 SFF 2026 Theme Round — HSEE
...
### 2.2 SFF 2026 Theme Round — Climate Change
...
|---|---|---|---|
| SFF 2026 Main Round | Apr 22, 2026 | ❌ Closed | Rolling apps deferred to next round |
| Constellation Generator Residency | Apr 27, 2026 | ❌ Closed | Missed by hours; EOI for future |
| MATS Summer 2026 | Closed | ❌ Closed | Collect EOI for future cohorts |
...
**Date**: _______
**Grants Submitted This Week**: _______
**Decisions Received**: _______
**Funds Received**: $_______
**Blockers Resolved**: _______
**New Blockers**: _______
**Next Week Priority**: _______
