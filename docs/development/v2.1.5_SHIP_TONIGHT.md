# Ship v2.1.5 Tonight - Action Checklist
...
**What's Already Done**:
- ✅ Terminal Tool fully implemented (`whitemagic/terminal/`)
- ✅ Semantic Search fully implemented (`whitemagic/search/semantic.py`)
- ✅ API routes exist for both features
- ✅ Tests exist: `test_terminal.py`, `test_semantic_search.py`
- ✅ Documentation exists: `TERMINAL_TOOL_DESIGN.md`, `TERMINAL_TOOL_USAGE.md`

**What Needs Doing**:
- ⏳ Enable Terminal Tool (currently disabled by default)
...
try:
    ...
    print(f"⚠️ Semantic Search needs configuration: {e}")
...
- Updated CHANGELOG.md with v2.1.5 details
- Created RELEASE_PLAN_v2.1.5_to_v2.1.9.md
...
## 🧪 Pre-Release Testing (30 minutes)
...
python3 -c "from whitemagic.search import SemanticSearcher; print('✅ OK')"

# 4. Check API app (doesn't crash on import)
python3 -c "from whitemagic.api.app import app; print('✅ OK')"
```
...
3. Tag: `v2.1.5`
4. Title: `v2.1.5: Terminal Tool + Semantic Search`
5. Description:

```markdown
# 🎉 WhiteMagic v2.1.5: Terminal Tool + Semantic Search

Major feature release enabling safe code execution and intelligent memory search.

## 🔧 Terminal Tool - Now Enabled

Execute commands safely with built-in approval workflows:
- ✅ **Read-only by default** (PROD profile)
- ✅ **Write with approval** (explicit `--write` flag required)
- ✅ **Full audit logging**
...
- [Release Plan v2.1.5-2.1.9](docs/RELEASE_PLAN_v2.1.5_to_v2.1.9.md)
- [Full Changelog](CHANGELOG.md)

## 🚀 What's Next

See [RELEASE_PLAN_v2.1.5_to_v2.1.9.md](docs/RELEASE_PLAN_v2.1.5_to_v2.1.9.md) for the roadmap to v2.1.9.

Next up (v2.1.6): Semantic search CLI integration + setup wizard.

---

**Full Changelog**: https://github.com/lbailey94/whitemagic/compare/v2.1.4...v2.1.5
```
...
**Ready?** Let's enable these powerful features and ship v2.1.5! 🚀
