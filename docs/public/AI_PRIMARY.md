...
Whitemagic gives AI agents persistent memory, cognitive upgrades, and more. It provides 829 callable tools across 801 dispatch entries (28 in PRAT mode), tiered persistent memory, ethical governance, and polyglot accelerators. Agents bring reasoning; Whitemagic provides Hands, Memory, and Conscience.

- **Hands** — 829 callable tools across 801 dispatch entries
...
# Or classic mode (801 dispatch tools)
...
- **MCP server (classic):** `WM_MCP_PRAT=0 python -m whitemagic.run_mcp` (801 dispatch tools)
...
The Polymorphic Resonant Adaptive Tools (PRAT) router maps all 801 dispatch tools into 28 Ganas — consciousness lenses based on the Chinese Lunar Mansions (Xiu 宿). Each Gana:
