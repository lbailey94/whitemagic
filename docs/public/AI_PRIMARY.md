# AI Primary Spec — Whitemagic v24.3.0

**The tool contract for AI agents using Whitemagic.**

Whitemagic gives AI agents persistent memory, cognitive upgrades, and more. It provides 757 callable tools across 729 dispatch entries (28 in PRAT mode), tiered persistent memory, ethical governance, and polyglot accelerators. Agents bring reasoning; Whitemagic provides Hands, Memory, and Conscience.

- **Hands** — 757 callable tools across 729 dispatch entries
...
# Or classic mode (729 dispatch tools)
...
- **MCP server (classic):** `WM_MCP_PRAT=0 python -m whitemagic.run_mcp` (729 dispatch tools)
...
The Polymorphic Resonant Adaptive Tools (PRAT) router maps all 729 dispatch tools into 28 Ganas — consciousness lenses based on the Chinese Lunar Mansions (Xiu 宿). Each Gana:
