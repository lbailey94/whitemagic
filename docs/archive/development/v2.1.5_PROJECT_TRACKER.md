...
3. **Conversion**: Smooth path from free → paid
...
|---|---------|----------|--------|--------|-------|
| **#3.1** | Basic Usage Dashboard | P0 | 📋 TODO | 1-2 days | TBD |
| **#3.2** | Usage API Endpoint | P0 | 📋 TODO | 0.5 days | TBD |
| **#3.3** | Plan Display from Whop | P0 | 📋 TODO | 0.5 days | TBD |
...
| # | Feature | Priority | Status | Effort | Owner |
|---|---------|----------|--------|--------|-------|
| **#4** | Tiered Feature Toggles | P1 | 📋 TODO | 1 week | TBD |
| **#5** | Usage Alerts (80% threshold) | P1 | 📋 TODO | 0.5 weeks | TBD |
| **#6** | Whop Webhook Integration | P1 | 📋 TODO | 0.5 weeks | TBD |
...
| # | Feature | Priority | Status | Effort | Owner |
|---|---------|----------|--------|--------|-------|
| **#7** | Advanced Analytics | P2 | 📋 TODO | 1 week | TBD |
| **#8** | Usage Export (CSV) | P2 | 📋 TODO | 0.5 days | TBD |
| **#9** | Custom Alert Thresholds | P2 | 📋 TODO | 0.5 days | TBD |
...
**Deliverable**: v2.1.5 ready to ship
...
- **Branch**: `v2.1.5-dev` (to be created)

---

## ✅ Definition of Done

v2.1.5 is ready to ship when:
