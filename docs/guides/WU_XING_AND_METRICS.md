# Wu Xing Phases & Metrics Hooks (v2.2.5)

WhiteMagic v2.2.5 adds a continuous-operations layer that detects which phase of the Wu Xing cycle you're currently in, while streaming quantitative metrics through new MCP tools. This guide shows how to use both.
