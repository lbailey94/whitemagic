...
Validate extension manifests without loading them. Checks each YAML file for required fields (name, description, gana, handler, safety) and reports errors. Use this before forge.reload to preview.
