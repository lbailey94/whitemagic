...
List active mandala compartments and available templates (MandalaOS Phase B). Shows shelter status, isolation tiers, dharma profiles, and template descriptions.
