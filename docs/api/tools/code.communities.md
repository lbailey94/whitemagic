...
Detect communities (subsystems) in the code structure graph. Uses Louvain community detection when networkx is available, falls back to connected components. Returns community sizes, member names, and associated files.
