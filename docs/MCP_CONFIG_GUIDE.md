...
requirement, and gzipped distributables on slow links); dynamically linked
builds remain for glibc 2.39+ hosts. macOS and Windows assets are static
within their platform's conventions. A binary built
