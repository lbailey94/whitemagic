...
Usage:
    python whitemagic_v5_server.py [--store PATH]
...
logger = logging.getLogger("whitemagic_v5")
...
class McpServer:
    ...
    def __init__(self, store_path: Path) -> None:
        ...
        logger.info("WhiteMagic v5 server initialized, store: %s", store_path)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="WhiteMagic v5 MCP Server (Python shell)"
    )
    parser.add_argument(
        "--store",
        type=Path,
