  ...
  return (
    <>
      <PageHeader
        ...
        title="What the lab saw, and what came true."
        lede="A complete, verifiable cross-domain forecasting track record. Every claim has a source timestamp and an independent validation event. Hits and misses are both published."
      />
