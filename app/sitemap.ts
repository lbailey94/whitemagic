...
const ROUTES = [
  ...
  { path: "/research/convergence-2026", priority: 0.6, changeFrequency: "monthly" as const },
  { path: "/research/may-2-window", priority: 0.6, changeFrequency: "monthly" as const },
  { path: "/research/survival-guide-2026", priority: 0.6, changeFrequency: "monthly" as const },
  ...
  { path: "/benchmarks", priority: 0.7, changeFrequency: "monthly" as const },
  ...
  { path: "/chat", priority: 0.6, changeFrequency: "weekly" as const },
  { path: "/essays", priority: 0.6, changeFrequency: "weekly" as const },
  { path: "/essays/horizons", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/essays/intelligence", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/essays/philosophy", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/essays/worldbuilding", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/grimoire", priority: 0.7, changeFrequency: "monthly" as const },
  { path: "/pricing", priority: 0.7, changeFrequency: "monthly" as const },
  { path: "/strata", priority: 0.6, changeFrequency: "monthly" as const },
  { path: "/getting-started", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/work", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/writing", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/services", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/services/agent-governance", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/services/mcp-engineering", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/services/private-ai-deployment", priority: 0.5, changeFrequency: "monthly" as const },
  ...
  { path: "/.well-known/ai-agent.json", priority: 0.5, changeFrequency: "weekly" as const },
  { path: "/server.json", priority: 0.5, changeFrequency: "weekly" as const },
