    ...
    <div className="min-h-screen bg-cream">
      <main className="mx-auto max-w-3xl px-6 py-24">
        ...
        <p className="mt-4 text-lg text-muted">
          A protected space for deep-garden exploration. Some parts are offline,
          some are drafts, and some are private. What is ready is shared; what is
          not stays here until it is.
        </p>
