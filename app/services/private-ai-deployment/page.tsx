  ...
  return (
    <WipGuard>
      ...
      <PageHeader
        ...
        title="Help running AI on your own hardware."
        lede="A complete private AI system — persistent memory, tool use, governance, audit — deployed on hardware you own, under compliance rules you already follow. If this isn't the right fit, I'll say so."
      />
