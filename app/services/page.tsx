...
export default function ServicesPage() {
  return (
    <WipGuard>
      <PageHeader
        eyebrow="Services"
        title="Help with governed agent infrastructure, from someone who has built it."
        lede="Every engagement starts with a 30-minute conversation. The center of gravity is evidence: policy, audit, observability, and deployment choices your team can defend. If the fit is not right, we'll say so. "
      />
