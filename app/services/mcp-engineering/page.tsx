  ...
  return (
    <>
      ...
      <PageHeader
        ...
        lede="The MCP ecosystem has 10,000+ servers. The new problem is not wiring up another server — it is governing, compressing, and observing them at scale. For teams betting real infrastructure on agent tooling."
      />
