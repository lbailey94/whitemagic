  ...
  return (
    <WipGuard>
      ...
      <PageHeader
        ...
        title="Help building guardrails your team can trust."
        lede="Runtime governance for AI agents: policy enforcement, identity, audit, and approval workflows. Everything your compliance team will ask for — and an honest conversation about whether my approach is right for your stack."
      />
      ...
      <section className="container-site grid gap-16 py-16 lg:grid-cols-[1.4fr_0.8fr]">
        <Prose>
          ...
          <p>
            ...
            Microsoft shipped the Agent Governance Toolkit v4.0.0 (Jun 2026) with
            992 conformance tests and 110 contributors — the enterprise standard
            for Azure teams. OpenTelemetry is standardizing GenAI and MCP spans.
            OWASP&apos;s GenAI work gives teams a risk vocabulary, and EU AI Act
            transparency obligations start taking effect in August 2026.
          </p>
          <p>
          ...
          <p>
            <strong>WhiteMagic&apos;s position:</strong> Microsoft AGT is the right
            choice for large Azure estates. WhiteMagic&apos;s Dharma Engine is the
            lightweight, framework-agnostic alternative for teams who need governance
            without the infrastructure overhead — or who need to extend AGT with
            custom policy logic, audit formats, or non-Azure runtimes.
          </p>
