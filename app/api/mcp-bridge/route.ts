 ...
 * MCP API surface. v22.4.0 expanded the catalog from 30 -> 143
 ...
 * crashed the entire MCP surface on import. v22.2.3 fixed it. v22.4.0
...
export async function GET() {
  const body = {
    ...
    notes: [
      ...
      "In v22.2.2 the bridge was completely broken (14 unguarded star imports). v22.2.3 fixed it; v22.4.0 documents the full 143-function surface.",
    ],
