 ...
 *
 * v23.0.0: zodiac_list_cores / zodiac_activate_core / zodiac_consult_council / zodiac_run_cycle
  ...
  return (
    <>
      <PageHeader
        ...
        title="Twelve cores, twelve ways of working."
        lede="The zodiac cores are coordination personas that route work across the substrate. Each sign is an element × mode combination with a distinct capability vector and a planetary ruler. Aries is live; the rest are in various stages of waking up."
      />
