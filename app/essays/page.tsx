    ...
    <main className="container-site py-16">
      <header className="mb-12">
        ...
        <h1 className="mt-2 font-head text-4xl font-semibold text-ink">
          Four ways of looking at the same question.
        </h1>
        <p className="mt-4 max-w-prose text-lg text-muted">
          Intelligence, horizons, worldbuilding, and philosophy — four domains,
          one epistemic standard. Every essay carries a tag — [Proven],
          [Promising], [Contested], [Speculative], or [Mythopoetic] — so you
          know exactly what kind of claim you&apos;re reading. Evidence is
          linked. Uncertainty is labeled. Speculation is marked as such. The
          goal is not to have answers but to ask better questions.
        </p>
      </header>
