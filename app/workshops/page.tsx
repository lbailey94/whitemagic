  ...
  return (
    <>
      <PageHeader
        ...
        lede="Hands-on AI literacy for individuals and small teams. Every session is designed around a concrete outcome: you leave with a skill or a setup, not just inspiration. If a session isn't the right fit, I'll say so."
      />
