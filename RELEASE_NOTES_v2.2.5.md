# WhiteMagic v2.2.5 Release Notes
...
v2.2.5 is a **transformational release** that reduces initial session token burn by **60-70%** while adding symbolic reasoning capabilities and automatic workflow phase detection.
...
- Synced MCP package.json from 2.2.3 → 2.2.5
...
mcp.call_tool("track_metric", {
    ...
    "value": 6500,
    "context": "v2.2.5 first session"
})
```

### Breaking Changes

**None** - v2.2.5 is fully backward compatible with v2.2.4
...
**Status**: Tracked for v2.2.6 fixes
...
WhiteMagic v2.2.5 represents a **major evolutionary leap** in AI memory management:
