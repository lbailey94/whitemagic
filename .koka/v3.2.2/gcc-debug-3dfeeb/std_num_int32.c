...
kk_string_t kk_std_num_int32_show_hex(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  _x_x173 = kk_integer_box(_x_x174, _ctx); /*10003*/
  _x_x172 = kk_std_core_types__new_Optional(_x_x173, _ctx); /*? 10003*/
  ...
  _x_x176 = kk_bool_box(_x_x177); /*10003*/
  _x_x175 = kk_std_core_types__new_Optional(_x_x176, _ctx); /*? 10003*/
  ...
  _x_x179 = kk_string_box(_x_x180); /*10003*/
  _x_x178 = kk_std_core_types__new_Optional(_x_x179, _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int32_show_hex32(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  _x_x185 = kk_integer_box(_x_x186, _ctx); /*10003*/
  _x_x184 = kk_std_core_types__new_Optional(_x_x185, _ctx); /*? 10003*/
  ...
  _x_x188 = kk_bool_box(_x_x189); /*10003*/
  _x_x187 = kk_std_core_types__new_Optional(_x_x188, _ctx); /*? 10003*/
  ...
  _x_x191 = kk_string_box(_x_x192); /*10003*/
  _x_x190 = kk_std_core_types__new_Optional(_x_x191, _ctx); /*? 10003*/
...
int32_t kk_std_num_int32_abs(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> exn int32 */ 
  ...
  bool _match_x156;
  kk_box_t _x_x196 = kk_std_core_hnd__open_none1(kk_std_num_int32_new_abs_fun197(_ctx), kk_bool_box(_x_x1_10070), _ctx); /*10001*/
  ...
  }
  {
    ...
    }
    {
      ...
      _x_x199 = kk_std_core_exn_throw(_x_x200, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
  ...
  }
  {
    ...
    if (_match_x151) {
      ...
      if (_match_x152) {
        ...
        _x_x205 = kk_std_core_exn_throw(_x_x206, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
...
int32_t kk_std_num_int32_cmod(int32_t i, int32_t j, kk_context_t* _ctx) { /* (i : int32, j : int32) -> exn int32 */ 
  ...
  if (_match_x147) {
    ...
    _x_x208 = kk_std_core_exn_throw(_x_x209, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
  ...
  }
  {
    ...
    if (_match_x148) {
      ...
      if (_match_x149) {
        ...
        _x_x211 = kk_std_core_exn_throw(_x_x212, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
...
kk_unit_t kk_std_num_int32_range_fs__lift_for32_3983(kk_function_t action_0, int32_t end_0, int32_t i_0, kk_context_t* _ctx) { /* forall<e> (action : (int32) -> e (), end : int32, i : int32) -> e () */ 
  ...
  if (_match_x118) {
    ...
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x225 = kk_std_core_hnd_yield_extend(kk_std_num_int32_range_fs__new_lift_for32_3983_fun226(action_0, end_0, i_0, _ctx), _ctx); /*10001*/
...
kk_std_core_types__maybe kk_std_num_int32_range_fs__lift_for_while32_3984(kk_function_t action_0, int32_t end_0, int32_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (int32) -> e maybe<a>, end : int32, i : int32) -> e maybe<a> */ 
  ...
  if (_match_x116) {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x229 = kk_std_core_hnd_yield_extend(kk_std_num_int32_range_fs__new_lift_for_while32_3984_fun230(action_0, end_0, i_0, _ctx), _ctx); /*10001*/
