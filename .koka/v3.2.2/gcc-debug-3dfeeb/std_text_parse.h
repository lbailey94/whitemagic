  ...
  kk_box_t _x_x868;
  {
    ...
    kk_std_text_parse__parse_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        _x_x868 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x15, (_fun_unbox_x15, m, ev_10203, kk_function_box(kk_std_text_parse_new_satisfy_fun871(pred, _ctx), _ctx), _ctx), _ctx); /*10010*/
      }
    }
  }
  ...
  kk_box_t _x_x880;
  {
    ...
    kk_std_text_parse__parse_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        _x_x880 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x33, (_fun_unbox_x33, m, ev_10209, _ctx), _ctx); /*10005*/
      }
    }
  }
  ...
  kk_box_t _x_x885;
  {
    ...
    kk_std_text_parse__parse_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        _x_x885 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x39, (_fun_unbox_x39, m, ev_10211, _ctx), _ctx); /*10005*/
      }
    }
  }
