...
#include "tmp_test__float__cmp2__main.h"
...
void kk_tmp_test__float__cmp2__main__init(kk_context_t* _ctx){
  ...
  kk_test__float__cmp2__init(_ctx);
...
void kk_tmp_test__float__cmp2__main__done(kk_context_t* _ctx){
  ...
  _kk_done = true;
    ...
    KK_CUSTOM_DONE (_ctx);
  #endif
  kk_test__float__cmp2__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_tmp_test__float__cmp2__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_tmp_test__float__cmp2__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_tmp_test__float__cmp2__main__done(_ctx);
}
