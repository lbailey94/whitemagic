...
kk_std_text_parse__parse_error kk_std_text_parse__mlift_parse_10178(kk_std_text_parse__parse_error err1, kk_function_t resume, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<h,a,e> (err1 : parse-error<a>, resume : (bool) -> <local<h>|e> parse-error<a>, wild_ : ()) -> <local<h>|e> parse-error<a> */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x897 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_parse_10178_fun898(err1, _ctx), _ctx); /*10001*/
...
kk_std_text_parse__parse_error kk_std_text_parse__mlift_parse_10179(kk_ref_t input, kk_function_t resume, kk_std_core_sslice__sslice save, kk_std_text_parse__parse_error _y_x10077, kk_context_t* _ctx) { /* forall<h,a,e> (input : local-var<h,sslice/sslice>, resume : (bool) -> <local<h>|e> parse-error<a>, save : sslice/sslice, parse-error<a>) -> <local<h>|e> parse-error<a> */ 
  ...
  }
  {
    ...
    _brw_x826;
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x903 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_parse_10179_fun904(_y_x10077, resume, _ctx), _ctx); /*10001*/
...
kk_std_text_parse__parse_error kk_std_text_parse__mlift_parse_10180(kk_ref_t input, kk_function_t resume, kk_std_core_sslice__sslice save, kk_context_t* _ctx) { /* forall<h,a,e> (input : local-var<h,sslice/sslice>, resume : (bool) -> <local<h>|e> parse-error<a>, save : sslice/sslice) -> <local<h>|e> parse-error<a> */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x907 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_parse_10180_fun908(input, resume, save, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse__mlift_parse_10182_fun911(kk_function_t _fself, kk_box_t _b_x68, kk_context_t* _ctx) {
  ...
  kk_std_core_types__maybe _x_x912 = kk_std_core_types__new_Just(x, _ctx); /*maybe<10024>*/
...
kk_std_core_types__maybe kk_std_text_parse__mlift_parse_10182(kk_ref_t input, kk_function_t pred, kk_std_core_sslice__sslice inp, kk_context_t* _ctx) { /* forall<a,h,e> (input : local-var<h,sslice/sslice>, pred : (sslice/sslice) -> maybe<(a, sslice/sslice)>, inp : sslice/sslice) -> <local<h>|e> maybe<a> */ 
  ...
  if (kk_std_core_types__is_Just(_match_x821, _ctx)) {
    ...
    _brw_x823;
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x910 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_parse_10182_fun911(x, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse_parse_fun923(kk_function_t _fself, kk_box_t _b_x81, kk_context_t* _ctx) {
  ...
  kk_box_t _b_x89 = _self->_b_x89; /* 10015 */
...
static kk_box_t kk_std_text_parse_parse_fun919(kk_function_t _fself, kk_function_t _b_x84, kk_context_t* _ctx) {
  ...
  kk_box_t _x_x920 = kk_ref_get(loc,kk_context()); /*10000*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x922 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_parse_fun923(_b_x89, _ctx), _ctx); /*10001*/
...
static kk_std_text_parse__parse_error kk_std_text_parse_parse_fun933(kk_function_t _fself, bool _b_x101, kk_context_t* _ctx) {
  ...
  kk_function_t _b_x100 = _self->_b_x100; /* (10001) -> 10002 10003 */
  kk_drop_match(_self, {kk_function_dup(_b_x100, _ctx);}, {}, _ctx)
  kk_box_t _x_x934 = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), _b_x100, (_b_x100, kk_bool_box(_b_x101), _ctx), _ctx); /*10003*/
...
static kk_box_t kk_std_text_parse_parse_fun932(kk_function_t _fself, kk_box_t _b_x99, kk_function_t _b_x100, kk_context_t* _ctx) {
  ...
  _x_x935 = kk_ref_get(_x_x936,kk_context()); /*10000*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x938 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_parse_fun939(loc, r_167, _ctx), _ctx); /*10001*/
...
static kk_std_core_types__maybe kk_std_text_parse_parse_fun945(kk_function_t _fself, kk_std_core_sslice__sslice _b_x120, kk_context_t* _ctx) {
  ...
  kk_box_t _b_x117 = _self->_b_x117; /* 10003 */
...
static kk_box_t kk_std_text_parse_parse_fun944(kk_function_t _fself, kk_box_t _b_x117, kk_context_t* _ctx) {
  ...
  _x_x948 = kk_ref_get(_x_x949,kk_context()); /*10000*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x951 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_parse_fun952(loc, pred_163, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse_parse_fun957(kk_function_t _fself, kk_box_t _b_x130, kk_context_t* _ctx) {
  ...
  kk_box_t _x_x958 = kk_ref_get(loc,kk_context()); /*10000*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x960 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_parse_fun961(_b_x130, _ctx), _ctx); /*10001*/
...
kk_std_text_parse__parse_error kk_std_text_parse_parse(kk_std_core_sslice__sslice input0, kk_function_t p, kk_context_t* _ctx) { /* forall<a,e> (input0 : sslice/sslice, p : () -> <parse|e> a) -> e parse-error<a> */ 
  ...
  kk_ref_dup(loc, _ctx);
  _x_x914 = kk_std_text_parse_new_parse_fun915(loc, _ctx); /*() -> 10000 10000*/
  _x_x913 = kk_std_core_hnd_clause_tail0(_x_x914, _ctx); /*hnd/clause0<10003,10002,10000,10001>*/
  kk_std_core_hnd__clause1 _x_x916;
  kk_function_t _x_x917;
  kk_ref_dup(loc, _ctx);
  _x_x917 = kk_std_text_parse_new_parse_fun918(loc, _ctx); /*(hnd/marker<10018,10019>, hnd/ev<10017>, 10015) -> 10018 10000*/
  _x_x916 = kk_std_core_hnd__new_Clause1(_x_x917, _ctx); /*hnd/clause1<10015,10016,10017,10018,10019>*/
  kk_std_core_hnd__clause0 _x_x928;
  kk_function_t _x_x929;
  kk_ref_dup(loc, _ctx);
  _x_x929 = kk_std_text_parse_new_parse_fun930(loc, _ctx); /*(hnd/marker<10012,10013>, hnd/ev<10011>) -> 10012 10000*/
  _x_x928 = kk_std_core_hnd__new_Clause0(_x_x929, _ctx); /*hnd/clause0<10010,10011,10012,10013>*/
  kk_std_core_hnd__clause1 _x_x942;
  kk_function_t _x_x943;
  kk_ref_dup(loc, _ctx);
  _x_x943 = kk_std_text_parse_new_parse_fun944(loc, _ctx); /*(10003) -> 10000 10004*/
  _x_x942 = kk_std_core_hnd_clause_tail1(_x_x943, _ctx); /*hnd/clause1<10003,10004,10002,10000,10001>*/
  ...
  kk_box_t _x_x964 = kk_std_core_hnd_prompt_local_var(loc, kk_std_text_parse__parse_error_box(res, _ctx), _ctx); /*10001*/
...
kk_std_core_types__maybe kk_std_text_parse_starts_with(kk_string_t s, kk_function_t p, kk_context_t* _ctx) { /* forall<a> (s : string, p : () -> parse a) -> maybe<(a, sslice/sslice)> */ 
  ...
  if (kk_std_text_parse__is_ParseOk(_match_x816, _ctx)) {
    ...
    kk_box_t _x_x969;
    kk_std_core_types__tuple2 _x_x970 = kk_std_core_types__new_Tuple2(x, kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x969 = kk_std_core_types__tuple2_box(_x_x970, _ctx); /*10024*/
...
kk_box_t kk_std_text_parse__lp__bar__bar__rp_(kk_function_t p1, kk_function_t p2, kk_context_t* _ctx) { /* forall<a,e> (p1 : parser<e,a>, p2 : parser<e,a>) -> <parse|e> a */ 
  ...
  bool x_10242;
  kk_box_t _x_x972 = kk_std_core_hnd__open_at0(_b_x183_185, kk_std_text_parse__lp__at_new_x_fun973_bar__bar__rp_(_ctx), _ctx); /*10000*/
...
kk_box_t kk_std_text_parse_choose(kk_std_core_types__list ps, kk_context_t* _ctx) { /* forall<a,e> (ps : list<parser<e,a>>) -> <parse|e> a */ 
  ...
  if (kk_std_core_types__is_Nil(ps, _ctx)) {
    ...
    _x_x982 = kk_string_box(_x_x983); /*10000*/
  ...
  }
  {
    ...
    bool x_0_10253;
    kk_box_t _x_x989 = kk_std_core_hnd__open_at0(_b_x215_217, kk_std_text_parse_new_choose_fun990(_ctx), _ctx); /*10000*/
  ...
  kk_box_t _x_x997;
  {
    ...
    kk_std_text_parse__parse_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        _x_x997 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x242, (_fun_unbox_x242, m, ev_10264, kk_function_box(kk_std_text_parse_new_satisfy_fail_fun1000(pred, _ctx), _ctx), _ctx), _ctx); /*10010*/
      }
    }
  }
    ...
    kk_box_t _x_x1007;
    {
      ...
      kk_std_text_parse__parse_dup(h, _ctx);
      {
        ...
        }
        {
          ...
          _x_x1010 = kk_string_box(_x_x1011); /*10009*/
          _x_x1007 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x265, (_fun_unbox_x265, m, ev_10270, _x_x1010, _ctx), _ctx); /*10010*/
        }
      }
    }
...
static kk_box_t kk_std_text_parse_eof_fun1016(kk_function_t _fself, kk_box_t _b_x283, kk_context_t* _ctx) {
  ...
  if (b_10032) {
    ...
    kk_box_t _x_x1019;
    kk_std_core_types__tuple2 _x_x1020 = kk_std_core_types__new_Tuple2(kk_unit_box(kk_Unit), _b_x283, _ctx); /*(10037, 10038)*/
    _x_x1019 = kk_std_core_types__tuple2_box(_x_x1020, _ctx); /*10024*/
...
kk_unit_t kk_std_text_parse_eof(kk_context_t* _ctx) { /* () -> parse () */ 
  ...
  kk_box_t _x_x1013;
  {
    ...
    kk_std_text_parse__parse_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        _x_x1013 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x277, (_fun_unbox_x277, m, ev_10276, kk_function_box(kk_std_text_parse_new_eof_fun1016(_ctx), _ctx), _ctx), _ctx); /*10010*/
      }
    }
  }
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1021 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_eof_fun1022(_ctx), _ctx); /*10001*/
    ...
    kk_box_t _x_x1025;
    {
      ...
      kk_std_text_parse__parse_dup(h_0, _ctx);
      {
        ...
        }
        {
          ...
          _x_x1028 = kk_string_box(_x_x1029); /*10009*/
          _x_x1025 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x297, (_fun_unbox_x297, m_0, ev_0_10279, _x_x1028, _ctx), _ctx); /*10010*/
        }
      }
    }
...
kk_box_t kk_std_text_parse__mlift_parse_eof_10189(kk_box_t x, kk_context_t* _ctx) { /* forall<a,e> (x : a) -> <parse|e> a */ 
  ...
  kk_box_t _x_x1032 = kk_std_core_hnd__open_at0(_b_x303_305, kk_std_text_parse__new_mlift_parse_eof_10189_fun1033(_ctx), _ctx); /*10000*/
  ...
  if (kk_std_core_types__is_Just(_match_x805, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (kk_function_call(bool, (kk_function_t, kk_char_t, kk_context_t*), _x_x1041, (_x_x1041, c, _ctx), _ctx)) {
        ...
        kk_box_t _x_x1042;
        kk_std_core_types__tuple2 _x_x1043 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1042 = kk_std_core_types__tuple2_box(_x_x1043, _ctx); /*10024*/
  ...
  if (kk_std_core_types__is_Just(_match_x804, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (kk_function_call(bool, (kk_function_t, kk_char_t, kk_context_t*), _x_x1045, (_x_x1045, c, _ctx), _ctx)) {
        ...
        { // tailcall
          kk_std_core_types__list _x_x1046 = kk_std_core_types__new_Cons(kk_reuse_null, 0, kk_char_box(c, _ctx), acc, _ctx); /*list<10021>*/
          slice = rest;
          acc = _x_x1046;
          goto kk__tailcall;
        }
...
static kk_std_core_types__maybe kk_std_text_parse_chars_are_fun1048(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x803, _ctx);
    kk_box_t _x_x1049;
    kk_std_core_types__tuple2 _x_x1050 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1049 = kk_std_core_types__tuple2_box(_x_x1050, _ctx); /*10024*/
...
static kk_std_core_types__maybe kk_std_text_parse_pstring_fun1054(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  if (kk_std_core_types__is_Just(_match_x801, _ctx)) {
    ...
    kk_box_t _x_x1057;
    kk_std_core_types__tuple2 _x_x1058 = kk_std_core_types__new_Tuple2(kk_string_box(s), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1057 = kk_std_core_types__tuple2_box(_x_x1058, _ctx); /*10024*/
  ...
  if (kk_std_core_types__is_Just(_match_x800, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (c == c_0) {
        ...
        kk_box_t _x_x1067;
        kk_std_core_types__tuple2 _x_x1068 = kk_std_core_types__new_Tuple2(kk_char_box(c_0, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1067 = kk_std_core_types__tuple2_box(_x_x1068, _ctx); /*10024*/
  ...
  if (kk_std_core_types__is_Just(_match_x798, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (_x_x1073) {
        ...
        kk_box_t _x_x1074;
        kk_std_core_types__tuple2 _x_x1075 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1074 = kk_std_core_types__tuple2_box(_x_x1075, _ctx); /*10024*/
...
kk_integer_t kk_std_text_parse__mlift_digit_10190(kk_char_t c_0_0, kk_context_t* _ctx) { /* (c@0@0 : char) -> parse int */ 
  kk_char_t _x_x1076;
  kk_box_t _x_x1077 = kk_std_core_hnd__open_none2(kk_std_text_parse__new_mlift_digit_10190_fun1078(_ctx), kk_char_box(c_0_0, _ctx), kk_char_box('0', _ctx), _ctx); /*10002*/
  ...
  if (kk_std_core_types__is_Just(_match_x796, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0_0, _ctx)) {
      ...
      if (_x_x1085) {
        ...
        kk_box_t _x_x1086;
        kk_std_core_types__tuple2 _x_x1087 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1086 = kk_std_core_types__tuple2_box(_x_x1087, _ctx); /*10024*/
...
kk_integer_t kk_std_text_parse_digit(kk_context_t* _ctx) { /* () -> parse int */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x1088 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_digit_fun1089(_ctx), _ctx); /*10001*/
    return kk_integer_unbox(_x_x1088, _ctx);
  }
  {
    kk_char_t _x_x1092;
    kk_box_t _x_x1093 = kk_std_core_hnd__open_none2(kk_std_text_parse_new_digit_fun1094(_ctx), kk_char_box(x_10288, _ctx), kk_char_box('0', _ctx), _ctx); /*10002*/
  ...
  if (kk_std_core_types__is_Just(_match_x794, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (kk_std_core_char_is_alpha(c, _ctx)) {
        ...
        kk_box_t _x_x1101;
        kk_std_core_types__tuple2 _x_x1102 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1101 = kk_std_core_types__tuple2_box(_x_x1102, _ctx); /*10024*/
  ...
  if (kk_std_core_types__is_Just(_match_x793, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (kk_std_core_char_is_alpha_num(c, _ctx)) {
        ...
        kk_box_t _x_x1107;
        kk_std_core_types__tuple2 _x_x1108 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1107 = kk_std_core_types__tuple2_box(_x_x1108, _ctx); /*10024*/
  ...
  if (kk_std_core_types__is_Just(_match_x792, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (kk_std_core_char_is_white(c, _ctx)) {
        ...
        kk_box_t _x_x1113;
        kk_std_core_types__tuple2 _x_x1114 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1113 = kk_std_core_types__tuple2_box(_x_x1114, _ctx); /*10024*/
...
static kk_std_core_types__maybe kk_std_text_parse_whitespace_fun1118(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x791, _ctx);
    kk_box_t _x_x1121;
    kk_std_core_types__tuple2 _x_x1122 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1121 = kk_std_core_types__tuple2_box(_x_x1122, _ctx); /*10024*/
...
kk_string_t kk_std_text_parse_whitespace(kk_context_t* _ctx) { /* () -> parse string */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1123 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace_fun1124(_ctx), _ctx); /*10001*/
...
static kk_std_core_types__maybe kk_std_text_parse_whitespace0_fun1132(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x789, _ctx);
    kk_box_t _x_x1135;
    kk_std_core_types__tuple2 _x_x1136 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1135 = kk_std_core_types__tuple2_box(_x_x1136, _ctx); /*10024*/
...
static kk_box_t kk_std_text_parse_whitespace0_fun1128(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1138 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace0_fun1139(_ctx), _ctx); /*10001*/
...
static kk_std_core_types__maybe kk_std_text_parse_digits_fun1148(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x787, _ctx);
    kk_box_t _x_x1151;
    kk_std_core_types__tuple2 _x_x1152 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1151 = kk_std_core_types__tuple2_box(_x_x1152, _ctx); /*10024*/
...
kk_string_t kk_std_text_parse_digits(kk_context_t* _ctx) { /* () -> parse string */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1153 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_digits_fun1154(_ctx), _ctx); /*10001*/
...
static kk_std_core_types__maybe kk_std_text_parse_digits0_fun1162(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x785, _ctx);
    kk_box_t _x_x1165;
    kk_std_core_types__tuple2 _x_x1166 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1165 = kk_std_core_types__tuple2_box(_x_x1166, _ctx); /*10024*/
...
static kk_box_t kk_std_text_parse_digits0_fun1158(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1168 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_digits0_fun1169(_ctx), _ctx); /*10001*/
...
kk_integer_t kk_std_text_parse__mlift_pnat_10191(kk_std_core_types__list _y_x10128, kk_context_t* _ctx) { /* (list<char>) -> parse int */ 
  ...
  kk_box_t _x_x1175 = kk_std_core_hnd__open_none2(kk_std_text_parse__new_mlift_pnat_10191_fun1176(_ctx), kk_string_box(_x_x1_0_10174), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*10002*/
  _x_x1_10172 = kk_std_core_types__maybe_unbox(_x_x1175, KK_OWNED, _ctx); /*maybe<int>*/
  kk_box_t _x_x1180 = kk_std_core_hnd__open_none2(kk_std_text_parse__new_mlift_pnat_10191_fun1181(_ctx), kk_std_core_types__maybe_box(_x_x1_10172, _ctx), kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*10002*/
...
static kk_std_core_types__maybe kk_std_text_parse_pnat_fun1186(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x782, _ctx);
    kk_box_t _x_x1189;
    kk_std_core_types__tuple2 _x_x1190 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1189 = kk_std_core_types__tuple2_box(_x_x1190, _ctx); /*10024*/
...
kk_integer_t kk_std_text_parse_pnat(kk_context_t* _ctx) { /* () -> parse int */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1191 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pnat_fun1192(_ctx), _ctx); /*10001*/
    return kk_integer_unbox(_x_x1191, _ctx);
  }
  {
    kk_string_t _x_x1_0_10174 = kk_std_core_string_listchar_fs_string(x_10299, _ctx); /*string*/;
    kk_std_core_types__maybe _x_x1_10172;
    kk_box_t _x_x1195 = kk_std_core_hnd__open_none2(kk_std_text_parse_new_pnat_fun1196(_ctx), kk_string_box(_x_x1_0_10174), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*10002*/
    _x_x1_10172 = kk_std_core_types__maybe_unbox(_x_x1195, KK_OWNED, _ctx); /*maybe<int>*/
    kk_box_t _x_x1200 = kk_std_core_hnd__open_none2(kk_std_text_parse_new_pnat_fun1201(_ctx), kk_std_core_types__maybe_box(_x_x1_10172, _ctx), kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*10002*/
  ...
  if (kk_std_core_types__is_Just(_match_x779, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (_x_x1209) {
        ...
        kk_box_t _x_x1210;
        kk_std_core_types__tuple2 _x_x1211 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1210 = kk_std_core_types__tuple2_box(_x_x1211, _ctx); /*10024*/
...
static kk_std_core_types__maybe kk_std_text_parse_none_of_many1_fun1215(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x778, _ctx);
    kk_box_t _x_x1218;
    kk_std_core_types__tuple2 _x_x1219 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1218 = kk_std_core_types__tuple2_box(_x_x1219, _ctx); /*10024*/
...
kk_string_t kk_std_text_parse_none_of_many1(kk_string_t chars, kk_context_t* _ctx) { /* (chars : string) -> parse string */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1220 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_none_of_many1_fun1221(_ctx), _ctx); /*10001*/
  ...
  if (kk_std_core_types__is_Just(_match_x776, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0, _ctx)) {
      ...
      if (kk_string_contains(_x_x1227,_x_x1228,kk_context())) {
        ...
        kk_box_t _x_x1229;
        kk_std_core_types__tuple2 _x_x1230 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1229 = kk_std_core_types__tuple2_box(_x_x1230, _ctx); /*10024*/
...
kk_std_core_types__list kk_std_text_parse__mlift_many_acc_10192(kk_std_core_types__list acc, kk_function_t p, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e> (acc : list<a>, p : parser<e,a>, x : a) -> <parse|e> list<a> */ 
  kk_std_core_types__list _x_x1231 = kk_std_core_types__new_Cons(kk_reuse_null, 0, x, acc, _ctx); /*list<10021>*/
...
static kk_box_t kk_std_text_parse_many_acc_fun1234(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1237 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_many_acc_fun1238(acc_0, p_0, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse_many_acc_fun1240(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_std_core_types__list _x_x1241 = kk_std_core_list_reverse_acc(kk_std_core_types__new_Nil(_ctx), acc_0, _ctx); /*list<10001>*/
...
static kk_box_t kk_std_text_parse__mlift_many1_10194_fun1243(kk_function_t _fself, kk_box_t _b_x656, kk_context_t* _ctx) {
  ...
  kk_std_core_types__list _x_x1244 = kk_std_core_types__new_Cons(kk_reuse_null, 0, _y_x10136, _y_x10137_658, _ctx); /*list<10021>*/
...
kk_std_core_types__list kk_std_text_parse__mlift_many1_10194(kk_function_t p, kk_box_t _y_x10136, kk_context_t* _ctx) { /* forall<a,e> (p : parser<e,a>, a) -> <parse|e> list<a> */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1242 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_many1_10194_fun1243(_y_x10136, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse_many1_fun1250(kk_function_t _fself, kk_box_t _b_x662, kk_context_t* _ctx) {
  ...
  kk_std_core_types__list _x_x1251 = kk_std_core_types__new_Cons(kk_reuse_null, 0, x_10310, _y_x10137_666, _ctx); /*list<10021>*/
...
kk_std_core_types__list kk_std_text_parse_many1(kk_function_t p, kk_context_t* _ctx) { /* forall<a,e> (p : parser<e,a>) -> <parse|e> list<a> */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1246 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_many1_fun1247(p, _ctx), _ctx); /*10001*/
  ...
  }
  {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x1249 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_many1_fun1250(x_10310, _ctx), _ctx); /*10001*/
...
kk_std_core_types__list kk_std_text_parse__mlift_count_acc_10195(kk_std_core_types__list acc, kk_integer_t n, kk_function_t p, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e> (acc : list<a>, n : int, p : parser<e,a>, x : a) -> <parse|e> list<a> */ 
  ...
  kk_std_core_types__list _x_x1253 = kk_std_core_types__new_Cons(kk_reuse_null, 0, x, acc, _ctx); /*list<10021>*/
...
kk_std_core_types__list kk_std_text_parse_count_acc(kk_integer_t n_0, kk_std_core_types__list acc_0, kk_function_t p_0, kk_context_t* _ctx) { /* forall<a,e> (n : int, acc : list<a>, p : parser<e,a>) -> <parse|e> list<a> */ 
  ...
  }
  {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x1255 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_count_acc_fun1256(acc_0, n_0, p_0, _ctx), _ctx); /*10001*/
    ...
    { // tailcall
      ...
      kk_std_core_types__list _x_x1259 = kk_std_core_types__new_Cons(kk_reuse_null, 0, x_0_10318, acc_0, _ctx); /*list<10021>*/
      n_0 = _x_x1258;
      acc_0 = _x_x1259;
      goto kk__tailcall;
    }
  ...
  if (kk_std_core_types__is_Just(_match_x769, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0_0, _ctx)) {
      ...
      if (kk_string_contains(_x_x1269,_x_x1271,kk_context())) {
        ...
        kk_box_t _x_x1272;
        kk_std_core_types__tuple2 _x_x1273 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1272 = kk_std_core_types__tuple2_box(_x_x1273, _ctx); /*10024*/
...
bool kk_std_text_parse_sign(kk_context_t* _ctx) { /* () -> parse bool */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x1275 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_sign_fun1276(_ctx), _ctx); /*10001*/
...
kk_integer_t kk_std_text_parse__mlift_pint_10198(kk_char_t c_0, kk_context_t* _ctx) { /* (c@0 : char) -> parse int */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1279 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_pint_10198_fun1280(neg, _ctx), _ctx); /*10001*/
  ...
  if (kk_std_core_types__is_Just(_match_x766, _ctx)) {
    ...
    if (kk_std_core_types__is_Tuple2(_pat_0_0, _ctx)) {
      ...
      if (kk_string_contains(_x_x1287,_x_x1289,kk_context())) {
        ...
        kk_box_t _x_x1290;
        kk_std_core_types__tuple2 _x_x1291 = kk_std_core_types__new_Tuple2(kk_char_box(c, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
        _x_x1290 = kk_std_core_types__tuple2_box(_x_x1291, _ctx); /*10024*/
...
kk_integer_t kk_std_text_parse_pint(kk_context_t* _ctx) { /* () -> parse int */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x1293 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pint_fun1294(_ctx), _ctx); /*10001*/
  ...
  }
  {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x1297 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pint_fun1298(neg, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse__mlift_sep_by1_10201_fun1303(kk_function_t _fself, kk_box_t _b_x725, kk_context_t* _ctx) {
  ...
  kk_std_core_types__list _x_x1304 = kk_std_core_types__new_Cons(kk_reuse_null, 0, _y_x10150, _y_x10153_727, _ctx); /*list<10021>*/
...
kk_std_core_types__list kk_std_text_parse__mlift_sep_by1_10201(kk_function_t p, kk_function_t sep, kk_box_t _y_x10150, kk_context_t* _ctx) { /* forall<a,b,e> (p : parser<e,a>, sep : parser<e,b>, a) -> <parse|e> list<a> */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1302 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift_sep_by1_10201_fun1303(_y_x10150, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_text_parse_sep_by1_fun1312(kk_function_t _fself, kk_box_t _b_x731, kk_context_t* _ctx) {
  ...
  kk_std_core_types__list _x_x1313 = kk_std_core_types__new_Cons(kk_reuse_null, 0, x_10344, _y_x10153_735, _ctx); /*list<10021>*/
...
kk_std_core_types__list kk_std_text_parse_sep_by1(kk_function_t p, kk_function_t sep, kk_context_t* _ctx) { /* forall<a,b,e> (p : parser<e,a>, sep : parser<e,b>) -> <parse|e> list<a> */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1306 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_sep_by1_fun1307(p, sep, _ctx), _ctx); /*10001*/
  ...
  }
  {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x1311 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_sep_by1_fun1312(x_10344, _ctx), _ctx); /*10001*/
...
static kk_std_core_types__maybe kk_std_text_parse_hex_digits_fun1321(kk_function_t _fself, kk_std_core_sslice__sslice slice, kk_context_t* _ctx) {
  ...
  }
  {
    ...
    kk_std_core_types__tuple2_drop(_match_x758, _ctx);
    kk_box_t _x_x1324;
    kk_std_core_types__tuple2 _x_x1325 = kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(xs, _ctx), kk_std_core_sslice__sslice_box(rest, _ctx), _ctx); /*(10037, 10038)*/
    _x_x1324 = kk_std_core_types__tuple2_box(_x_x1325, _ctx); /*10024*/
...
kk_string_t kk_std_text_parse_hex_digits(kk_context_t* _ctx) { /* () -> parse string */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x1326 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_hex_digits_fun1327(_ctx), _ctx); /*10001*/
