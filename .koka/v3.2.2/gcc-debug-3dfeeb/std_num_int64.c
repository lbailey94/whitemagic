...
kk_string_t kk_std_num_int64_show_hex(int64_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int64, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  _x_x287 = kk_integer_box(_x_x288, _ctx); /*10003*/
  _x_x286 = kk_std_core_types__new_Optional(_x_x287, _ctx); /*? 10003*/
  ...
  _x_x290 = kk_bool_box(_x_x291); /*10003*/
  _x_x289 = kk_std_core_types__new_Optional(_x_x290, _ctx); /*? 10003*/
  ...
  _x_x293 = kk_string_box(_x_x294); /*10003*/
  _x_x292 = kk_std_core_types__new_Optional(_x_x293, _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int64_show_hex64(int64_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int64, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  _x_x298 = kk_integer_box(_x_x299, _ctx); /*10003*/
  _x_x297 = kk_std_core_types__new_Optional(_x_x298, _ctx); /*? 10003*/
  ...
  _x_x301 = kk_bool_box(_x_x302); /*10003*/
  _x_x300 = kk_std_core_types__new_Optional(_x_x301, _ctx); /*? 10003*/
  ...
  _x_x304 = kk_string_box(_x_x305); /*10003*/
  _x_x303 = kk_std_core_types__new_Optional(_x_x304, _ctx); /*? 10003*/
...
int64_t kk_std_num_int64_abs(int64_t i, kk_context_t* _ctx) { /* (i : int64) -> exn int64 */ 
  ...
  bool _match_x264;
  kk_box_t _x_x312 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_abs_fun313(_ctx), kk_bool_box(_x_x1_10096), _ctx); /*10001*/
  ...
  }
  {
    ...
    if (_match_x265) {
      _x_x315 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_abs_fun316(_ctx), kk_int64_box(i, _ctx), _ctx); /*10001*/
    }
    else {
      kk_string_t _x_x319;
      ...
      _x_x315 = kk_std_core_exn_throw(_x_x319, kk_std_core_types__new_None(_ctx), _ctx); /*10001*/
    }
...
int64_t kk_std_num_int64_cdiv(int64_t i, int64_t j, kk_context_t* _ctx) { /* (i : int64, j : int64) -> exn int64 */ 
  ...
  if (_match_x258) {
    ...
    _x_x328 = kk_std_core_exn_throw(_x_x329, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
  ...
  }
  {
    ...
    bool _match_x259;
    int64_t _x_x333;
    kk_box_t _x_x334 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_cdiv_fun335(_b_x40_47, _ctx), kk_integer_box(_b_x41_48, _ctx), _ctx); /*10001*/
    ...
    if (_match_x259) {
      ...
      if (_match_x260) {
        ...
        _x_x338 = kk_std_core_exn_throw(_x_x339, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
...
int64_t kk_std_num_int64_cmod(int64_t i, int64_t j, kk_context_t* _ctx) { /* (i : int64, j : int64) -> exn int64 */ 
  ...
  if (_match_x255) {
    ...
    _x_x341 = kk_std_core_exn_throw(_x_x342, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
  ...
  }
  {
    ...
    bool _match_x256;
    int64_t _x_x346;
    kk_box_t _x_x347 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_cmod_fun348(_b_x53_60, _ctx), kk_integer_box(_b_x54_61, _ctx), _ctx); /*10001*/
    ...
    if (_match_x256) {
      ...
      if (_match_x257) {
        ...
        _x_x351 = kk_std_core_exn_throw(_x_x352, kk_std_core_types__new_None(_ctx), _ctx); /*10000*/
...
kk_std_core_types__maybe kk_std_num_int64_range_fs__lift_for_while64_4126(kk_function_t action_0, int64_t end_0, int64_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64) -> e maybe<a> */ 
  ...
  if (_match_x230) {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x390 = kk_std_core_hnd_yield_extend(kk_std_num_int64_range_fs__new_lift_for_while64_4126_fun391(action_0, end_0, i_0, _ctx), _ctx); /*10001*/
...
kk_string_t kk_std_num_int64_test_prefix_sum(kk_context_t* _ctx) { /* () -> string */ 
  ...
  _x_x408 = kk_integer_box(_x_x409, _ctx); /*10003*/
  _x_x407 = kk_std_core_types__new_Optional(_x_x408, _ctx); /*? 10003*/
  ...
  _x_x411 = kk_bool_box(_x_x412); /*10003*/
  _x_x410 = kk_std_core_types__new_Optional(_x_x411, _ctx); /*? 10003*/
  ...
  _x_x414 = kk_string_box(_x_x415); /*10003*/
  _x_x413 = kk_std_core_types__new_Optional(_x_x414, _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int64_test_bit_spread1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  _x_x419 = kk_integer_box(_x_x420, _ctx); /*10003*/
  _x_x418 = kk_std_core_types__new_Optional(_x_x419, _ctx); /*? 10003*/
  ...
  _x_x422 = kk_bool_box(_x_x423); /*10003*/
  _x_x421 = kk_std_core_types__new_Optional(_x_x422, _ctx); /*? 10003*/
  ...
  _x_x425 = kk_string_box(_x_x426); /*10003*/
  _x_x424 = kk_std_core_types__new_Optional(_x_x425, _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int64_test_bit_spread2(kk_context_t* _ctx) { /* () -> string */ 
  ...
  _x_x430 = kk_integer_box(_x_x431, _ctx); /*10003*/
  _x_x429 = kk_std_core_types__new_Optional(_x_x430, _ctx); /*? 10003*/
  ...
  _x_x433 = kk_bool_box(_x_x434); /*10003*/
  _x_x432 = kk_std_core_types__new_Optional(_x_x433, _ctx); /*? 10003*/
  ...
  _x_x436 = kk_string_box(_x_x437); /*10003*/
  _x_x435 = kk_std_core_types__new_Optional(_x_x436, _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int64_test_clmulr1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  kk_std_core_types__optional _x_x446 = kk_std_core_types__new_Optional(kk_integer_box(_b_x149_160, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x447 = kk_std_core_types__new_Optional(kk_bool_box(_b_x151_161), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x448 = kk_std_core_types__new_Optional(kk_string_box(_b_x153_162), _ctx); /*? 10003*/
  ...
  kk_std_core_types__optional _x_x455 = kk_std_core_types__new_Optional(kk_integer_box(_b_x155_163, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x456 = kk_std_core_types__new_Optional(kk_bool_box(_b_x157_164), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x457 = kk_std_core_types__new_Optional(kk_string_box(_b_x159_165), _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int64_test_clmulr2(kk_context_t* _ctx) { /* () -> string */ 
  ...
  kk_std_core_types__optional _x_x463 = kk_std_core_types__new_Optional(kk_integer_box(_b_x167_178, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x464 = kk_std_core_types__new_Optional(kk_bool_box(_b_x169_179), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x465 = kk_std_core_types__new_Optional(kk_string_box(_b_x171_180), _ctx); /*? 10003*/
  ...
  kk_std_core_types__optional _x_x472 = kk_std_core_types__new_Optional(kk_integer_box(_b_x173_181, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x473 = kk_std_core_types__new_Optional(kk_bool_box(_b_x175_182), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x474 = kk_std_core_types__new_Optional(kk_string_box(_b_x177_183), _ctx); /*? 10003*/
...
kk_string_t kk_std_num_int64_test_clmulrev1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  kk_std_core_types__optional _x_x485 = kk_std_core_types__new_Optional(kk_integer_box(_b_x185_196, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x486 = kk_std_core_types__new_Optional(kk_bool_box(_b_x187_197), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x487 = kk_std_core_types__new_Optional(kk_string_box(_b_x189_198), _ctx); /*? 10003*/
  ...
  kk_std_core_types__optional _x_x494 = kk_std_core_types__new_Optional(kk_integer_box(_b_x191_199, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x495 = kk_std_core_types__new_Optional(kk_bool_box(_b_x193_200), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x496 = kk_std_core_types__new_Optional(kk_string_box(_b_x195_201), _ctx); /*? 10003*/
