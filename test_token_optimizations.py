...
def main():
    ...
    print(f"Tier 0 (scan):        {int(tier0_tokens):,} tokens ({100*(1-tier0_tokens/baseline_tokens):.1f}% reduction)")
    print(f"Tier 1 (balanced):    {int(tier1_tokens):,} tokens ({100*(1-tier1_tokens/baseline_tokens):.1f}% reduction)")
    print(f"Tier 1 + query:       {int(tier1_query_tokens):,} tokens ({100*(1-tier1_query_tokens/baseline_tokens):.1f}% reduction)")
