...
export function ToolGraph({ height = 500 }: { height?: number }) {
  ...
  return (
    ...
    >
      <canvas
        ...
        role="img"
        aria-label={`Tool dependency graph showing ${TOOLS.length} tools across ${categories.length} categories with ${EDGES.length} edges`}
      />
      ...
      <div className="absolute top-4 left-4 text-sm font-semibold text-gray-400 z-10">
