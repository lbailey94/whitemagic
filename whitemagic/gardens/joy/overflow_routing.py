...
class OverflowRouter:
    ...
    def route_overflow(self, surplus_type: SurplusType) -> Optional[List[str]]:
        """
    ...
    def gift_to_world(self, gift: str, gift_type: SurplusType) -> str:
        ...
        if not destinations:
            return f"💝 Gift created but cup not full yet. Tend your own joy first!"
