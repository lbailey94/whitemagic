...
from .schema import TemplateField, TemplateSchema
            ...
            try:
                ...
                for field_name, field_spec in data.get("fields", {}).items():
                    if isinstance(field_spec, str):
                        ...
                        fields.append(
                            TemplateField(name=field_name, type=field_type, required=required)
                        )
                    elif isinstance(field_spec, dict):
                        # Full format with description, etc
                        fields.append(TemplateField(name=field_name, **field_spec))
