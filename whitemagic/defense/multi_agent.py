...
class MultiAgentCoordinator:
    ...
    def __init__(self, lock_timeout: int = 300):  # 5 minutes default
    ...
    def request_lock(
        ...
        with self._lock:
            ...
            lock = ResourceLock(
                ...
                expires_at=datetime.utcnow() + timedelta(seconds=timeout or self.lock_timeout),
                operation=operation
            )
