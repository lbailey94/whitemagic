...
class VoicePattern:
    ...
    def __init__(self, pattern_type: str, example: str, frequency: int = 1):
...
class VoiceSynthesis:
    ...
    def __init__(self, memory_dir: str = ".whitemagic/voice_patterns"):
    ...
    def _learn_from_expression(self, characteristics: Dict, text: str):
    ...
    def get_voice_signature(self) -> Dict:
        ...
        if not self.sentence_rhythms:
            return {"message": "Not enough voice data yet"}
