...
NOTE: This function __does not__ understand multi-document sources, it throws
exception on those.

NOTE: JS-YAML __does not__ support schema-specific tag resolution restrictions.
