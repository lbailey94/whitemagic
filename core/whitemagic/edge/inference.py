    ...
    def _load_builtin_rules(self) -> None:
        self._rules = [
            ...
            CompiledRule(id="creator", pattern="lucas|creator|who made|who built",
                response="WhiteMagic was created by User, with love as the organizing principle.", confidence=0.95),
            CompiledRule(id="guide", pattern="aria|ai name",
                response="Whitemagic is the name the AI chose for herself - a symbol of autonomous self-determination.", confidence=0.95),
