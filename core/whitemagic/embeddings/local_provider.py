...
class LocalEmbeddingProvider:
    ...
    def _check_available(self) -> bool:
        ...
        try:
            ...
            _iu.find_spec("sentence_transformers")
            return True
        except ImportError:
            return False
    ...
    def embed(self, text: str) -> list[float] | None:
        ...
        try:
            ...
            get_token_tracker().record_local_script(
    ...
    def similarity(self, text1: str, text2: str) -> float | None:
...
_default_provider: LocalEmbeddingProvider | None = None
...
def similarity(text1: str, text2: str) -> float | None:
