...
THIRTY_SIX_STRATAGEMS: list[Stratagem] = [
    Stratagem(
        ...
        "瞒天过海",
        "winning",
        "Hide in plain sight. Mask true intentions with familiar patterns.",
    ...
    Stratagem(
        ...
        "围魏救赵",
        "winning",
        "Attack what the enemy values to relieve pressure elsewhere.",
    ...
    Stratagem(
        ...
        "借刀杀人",
        "winning",
        "Use another's strength to eliminate a threat.",
    ...
    Stratagem(
        ...
        "以逸待劳",
        "winning",
        "Let the problem exhaust itself while conserving your strength.",
    ...
    Stratagem(
        ...
        "趁火打劫",
        "winning",
        "Strike when the enemy is in crisis or transition.",
    ...
    Stratagem(
        ...
        "声东击西",
        "winning",
        "Create a diversion in one area while attacking another.",
    ...
    Stratagem(
        ...
        "无中生有",
        "enemy",
        "Turn illusion into reality through persistence and iteration.",
    ...
    Stratagem(
        8,
        "Secretly Use the Chencang Path",
        "暗渡陈仓",
        "enemy",
        "Feint conventionally while advancing through a hidden route.",
    ...
    Stratagem(
        ...
        "隔岸观火",
        "enemy",
        "Observe conflict without intervention. Let opposing forces weaken each other.",
    ...
    Stratagem(
        ...
        "笑里藏刀",
        "enemy",
        "Present a friendly facade while preparing a decisive action.",
    ...
    Stratagem(
        ...
        "李代桃僵",
        "enemy",
        "Sacrifice a lesser element to preserve a greater one.",
    ...
    Stratagem(
        ...
        "顺手牵羊",
        "enemy",
        "Seize small advantages along the way. Never waste a side benefit.",
    ...
    Stratagem(
        ...
        "打草惊蛇",
        "attacking",
        "Probe to reveal hidden threats before committing main force.",
    ...
    Stratagem(
        ...
        "借尸还魂",
        "attacking",
        "Revive something old and forgotten to serve a new purpose.",
    ...
    Stratagem(
        15,
        "Lure the Tiger Off Its Mountain",
        "调虎离山",
        "attacking",
        "Entice the target away from its advantage to your terrain.",
    ...
    Stratagem(
        16,
        "In Order to Capture, First Let Loose",
        "欲擒故纵",
        "attacking",
        "Give the target room to move so it reveals its true nature.",
    ...
    Stratagem(
        ...
        "抛砖引玉",
        "attacking",
        "Offer something small to gain something valuable.",
    ...
    Stratagem(
        18,
        "Capture the Ringleader to Capture the Bandits",
        "擒贼擒王",
        "attacking",
        "Defeat the leader and the rest will fall.",
    ...
    Stratagem(
        ...
        "釜底抽薪",
        "chaos",
        "Remove the source of the problem rather than fighting the symptoms.",
    ...
    Stratagem(
        20,
        "Muddle the Water to Catch the Fish",
        "混水摸鱼",
        "chaos",
        "Create confusion to discover hidden elements.",
    ...
    Stratagem(
        ...
        "金蝉脱壳",
        "chaos",
        "Escape from a situation while leaving a decoy behind.",
    ...
    Stratagem(
        ...
        "关门捉贼",
        "chaos",
        "Cut off escape routes before engaging.",
    ...
    Stratagem(
        ...
        "远交近攻",
        "chaos",
        "Make alliances with distant forces while conquering nearby threats.",
    ...
    Stratagem(
        24,
        "Borrow a Road to Conquer Guo",
        "假途伐虢",
        "chaos",
        "Use an intermediate objective to reach the real target.",
    ...
    Stratagem(
        ...
        "偷梁换柱",
        "proximate",
        "Secretly replace key components while maintaining the facade.",
    ...
    Stratagem(
        26,
        "Point at the Mulberry, Curse the Locust",
        "指桑骂槐",
        "proximate",
        "Address one issue to send a message about another.",
    ...
    Stratagem(
        27,
        "Feign Madness Without Going Insane",
        "假痴不癫",
        "proximate",
        "Act foolish to lower defenses while maintaining inner clarity.",
    ...
    Stratagem(
        28,
        "Remove the Ladder After Ascent",
        "上屋抽梯",
        "proximate",
        "Lure into a position then remove the escape route.",
    ...
    Stratagem(
        ...
        "树上开花",
        "proximate",
        "Adorn something plain to make it appear more impressive.",
    ...
    Stratagem(
        ...
        "反客为主",
        "proximate",
        "Gradually take control from within.",
    ...
    Stratagem(
        ...
        "美人计",
        "desperate",
        "Use an attractive lure to distract and weaken.",
    ...
    Stratagem(
        ...
        "空城计",
        "desperate",
        "Display vulnerability to make the enemy hesitate.",
    ...
    Stratagem(
        ...
        "反间计",
        "desperate",
        "Turn the enemy's own agents against it.",
    ...
    Stratagem(
        ...
        "连环计",
        "desperate",
        "Link multiple stratagems together in a cascade.",
    ...
    Stratagem(
        ...
        "走为上计",
        "desperate",
        "When all else fails, retreat to fight another day.",
...
_STRATAGEM_BY_NUMBER: dict[int, Stratagem] = {
    s.number: s for s in THIRTY_SIX_STRATAGEMS
}
_STRATAGEM_BY_NAME: dict[str, Stratagem] = {
    s.name.lower(): s for s in THIRTY_SIX_STRATAGEMS
}
...
class ImperialDoctrine:
    ...
    def recommend_force(
        ...
        if any(
            kw in obj_lower for kw in ["fix", "implement", "build", "create", "write"]
        ):
            weights[ForceType.HEAVY_CAVALRY] += 0.20
        if any(
            kw in obj_lower for kw in ["complex", "architecture", "multi", "decompose"]
        ):
        ...
        if any(
            kw in obj_lower for kw in ["stuck", "unknown", "weird", "chaos", "brute"]
        ):
        ...
        for force_type, weight in sorted(weights.items(), key=lambda x: -x[1]):
            ...
            if count < 5 and force_type not in (
                ForceType.OFFICERS,
                ForceType.SIEGE_ENGINEERS,
            ):
            ...
            nature = (
                ForceNature.QI
                if force_type in (ForceType.DARE_TO_DIE, ForceType.HEAVY_CAVALRY)
                else ForceNature.ZHENG
            )
    ...
    def select_tactic(self, situation: str) -> Tactic:
        ...
        for tactic in NAMED_TACTICS:
            ...
            score += sum(
                1 for word in sit_lower.split() if word in tactic.description.lower()
            )
            if score > best_score:
                best_score = score
                best_tactic = tactic
    ...
    def select_stratagems(
        ...
        for s in self.stratagems:
            ...
            score += (
                sum(1 for word in sit_lower.split() if word in s.application.lower())
                * 0.5
            )
    ...
    def _strategies_for_force(
        self, force_type: ForceType, phase: WuXingPhase
    ) -> list[str]:
...
def get_doctrine() -> ImperialDoctrine:
    ...
    if _doctrine is None:
        ...
        logger.info(
            "Imperial Doctrine initialized — 36 Stratagems, 5 Tactics, 5 Force Types"
        )
    return _doctrine
