...
class JoyResonance:
    ...
    def get_joy_patterns(self) -> dict[str, any]:
        ...
        return {
            ...
            "latest_joy": self.joy_moments[-1].description if self.joy_moments else None
        }
...
def share_joy(source: str, description: str, intensity: float, spark: str, feeling: str):
    """Convenience function - share a joy moment!"""
    return get_joy_resonance().experience_joy(source, description, intensity, spark, feeling)
