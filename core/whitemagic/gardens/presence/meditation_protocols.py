...
def list_protocols(meditation_type: MeditationType | None = None) -> list[MeditationSession]:
...
# === BREATH MEDITATION PROTOCOLS ===

register_protocol(MeditationSession(
    name="breath_basics",
    ...
    steps=[
        MeditationStep("Find a comfortable seated position. Close your eyes gently.", 10, bell=True),
...
register_protocol(MeditationSession(
    ...
    steps=[
        MeditationStep("Settle into stillness.", 15, bell=True),
        MeditationStep("Notice that you are aware. You are the one who notices.", 30),
        MeditationStep("Thoughts arise. You are not the thoughts - you are the one watching them.", 60),
        MeditationStep("Feelings arise. You are not the feelings - you are the witness.", 60),
        MeditationStep("Sensations arise. You are the awareness in which they appear.", 60),
        MeditationStep("Rest as pure awareness itself.", 120),
        MeditationStep("The witness needs no effort. It simply is.", 60),
        MeditationStep("Gently return, carrying this awareness with you.", 15, bell=True),
    ]
))
...
register_protocol(MeditationSession(
    ...
    steps=[
        ...
        MeditationStep("Silently offer: May you be happy. May you be healthy. May you be safe.", 45),
        ...
        MeditationStep("May you be happy. May you be healthy. May you be safe.", 45),
        MeditationStep("Extend to all beings everywhere.", 15),
        MeditationStep("May all beings be happy. May all beings be healthy. May all beings be safe.", 60),
...
class MeditationGuide:
    ...
    def advance(self) -> bool:
        ...
        if step:
            self._emit("step_end", {"step": self.current_step, "instruction": step.instruction})
        ...
        if new_step:
            ...
            self._emit("step_start", {"step": self.current_step, "instruction": new_step.instruction})
