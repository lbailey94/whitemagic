...
DAO_PRINCIPLES = [
    ...
    DaoChapter(
        8,
        "The highest good is like water - benefits all without striving",
        "Wu Wei: Let solutions flow naturally to where they're needed",
    ),
    DaoChapter(
        11,
        "Thirty spokes share the wheel's hub - it is the void that makes it useful",
    ...
    DaoChapter(
        37,
        "Dao never acts yet nothing is left undone",
