...
_TOOL_CODEBOOK: dict[str, str] = {
    ...
    "vector.index": "Mx",
    "vector.status": "Ms",
    "session_bootstrap": "Sb",
    "create_session": "Sc",
    "resume_session": "Sr",
    "checkpoint_session": "Sk",
    "scratchpad": "Hs",
    "session.handoff": "Hh",
    "context.pack": "Hp",
    "context.status": "Hq",
    "working_memory.attend": "Ha",
    "working_memory.context": "Hc",
    "working_memory.status": "Ht",
    "get_session_context": "Hg",
    "gnosis": "Gg",
    "capabilities": "Gc",
    "manifest": "Gm",
    ...
    "cluster_stats": "Xc",
    "tool.graph": "Xg",
    "learning.patterns": "Xl",
    "learning.suggest": "Xs",
    "learning.status": "Xt",
    "governor_validate": "Vv",
    "governor_set_goal": "Vg",
    "governor_check_drift": "Vd",
    "dharma.reload": "VD",
    "set_dharma_profile": "Vp",
    "prat_invoke": "Vi",
    "prat_status": "Vs",
    "dream": "Dd",
    "memory.lifecycle": "Dl",
    "memory.retention_sweep": "Dr",
    "serendipity_surface": "Ds",
    "pulse.status": "Dp",
    "entity_resolve": "De",
    "view_hologram": "Oh",
    "track_metric": "Ot",
    "get_yin_yang_balance": "Oy",
    "record_yin_yang_activity": "OY",
    "green.report": "Og",
    "cache.status": "Oc",
    "cache.flush": "Of",
    "cache.tune": "Ou",
    ...
    "check_boundaries": "Eb",
    "verify_consent": "Ec",
    "get_ethical_score": "Es",
    "get_dharma_guidance": "Ed",
    "harmony_vector": "Eh",
    "simd.cosine": "Tc",
    "simd.batch": "Tb",
    "simd.status": "Ts",
    ...
    "grimoire_suggest": "Zs",
    "grimoire_cast": "Zc",
    "grimoire_recommend": "Zr",
    "grimoire_auto_status": "Za",
    "grimoire_walkthrough": "Zw",
    "navigate_grimoire": "Zn",
    "rate_limiter.stats": "Zt",
    "cast_oracle": "Zo",
    "forge.status": "Fs",
    "forge.reload": "Fr",
    "forge.validate": "Fv",
...
_ARG_KEY_CODEBOOK: dict[str, str] = {
    ...
    "ids": "k",
    "include_metadata": "M",
    "include_embeddings": "E",
    "include_diagnostics": "N",
    "min_confidence": "F",
    "min_novelty": "J",
    # ── Session / context ──
    "phase": "P",
