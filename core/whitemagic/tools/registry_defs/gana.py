...
def _gana(
    name: str, desc: str, safety: ToolSafety, extra_props: dict | None = None
) -> ToolDefinition:
...
TOOLS: list[ToolDefinition] = [
    ...
    _gana(
        ...
        ToolSafety.WRITE,
        {"target_tool": {"type": "string"}, "query": {"type": "string"}},
    ),
    _gana(
        "gana_extended_net",
    ...
    _gana(
        ...
        ToolSafety.WRITE,
        {"strategy_goal": {"type": "string"}},
    ),
    _gana(
        "gana_ox", "[OX] Endurance & Watchdog. Lens: Steady vigilance.", ToolSafety.READ
    ),
    _gana(
        "gana_girl",
    ...
    _gana(
        "gana_void", "[VOID] Emptiness & Defrag. Lens: Sacred space.", ToolSafety.WRITE
    ),
    _gana(
        "gana_roof",
