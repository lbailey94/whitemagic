...
DISPATCH_MEMORY: dict[str, Callable[..., dict[str, Any]]] = {
    ...
    "simulation.run": LazyHandler("simulation", "handle_simulation_run"),
    "simulation.search": LazyHandler("simulation", "handle_simulation_search"),
    "simulation.inject": LazyHandler("simulation", "handle_simulation_inject"),
    ...
    "consciousness.mode": LazyHandler("neuro_cognitive", "handle_consciousness_mode"),
    "guna.balance.status": LazyHandler("neuro_cognitive", "handle_guna_balance_status"),
    "guna.correct": LazyHandler("neuro_cognitive", "handle_guna_correct"),
    ...
    "emergence.insights": LazyHandler("neuro_cognitive", "handle_emergence_insights"),
    "citta.ignitions": LazyHandler("neuro_cognitive", "handle_citta_ignitions"),
    "cognitive.patterns": LazyHandler("neuro_cognitive", "handle_cognitive_patterns"),
    "cognitive.signals": LazyHandler("neuro_cognitive", "handle_cognitive_signals"),
    "cognitive.action_loop": LazyHandler("neuro_cognitive", "handle_cognitive_action_loop"),
