...
TOOL_TO_GANA: dict[str, str] = {
    ...
    "search.telemetry": "gana_winnowing_basket",
    ...
    "ambient.status": "gana_ghost",
    "bounty.auto_claim": "gana_abundance",
    "bounty.scan": "gana_abundance",
    "bounty.connector_status": "gana_abundance",
    "bounty.scan_all": "gana_abundance",
    "bounty.poc_generate": "gana_chariot",
    "bounty.report_generate": "gana_wall",
    "genetic.run": "gana_ox",
    "genetic.status": "gana_ox",
    "model.optimize": "gana_dipper",
    "model.optimize_status": "gana_dipper",
    "network_state.create_identity": "gana_wall",
    "network_state.propose": "gana_wall",
    "network_state.resolve": "gana_wall",
