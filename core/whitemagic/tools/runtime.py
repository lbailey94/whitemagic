...
Phase 1 of the Codebase Hardening Strategy. This module defines:

- ``ExecutionMode``: explicit enum replacing implicit name-based behavior
- ``ToolRequest``: typed request with all identity fields
- ``ToolResult``: typed result with status, payload, and metadata
- ``ToolRuntime``: the canonical execution boundary
