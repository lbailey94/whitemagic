...
_DISPATCH_OPERATIONAL: dict[str, Callable[..., dict[str, Any]]] = {
    ...
    "bounty.scan_all": LazyHandler("v24_3_handlers", "handle_bounty_scan_all"),
    "bounty.poc_generate": LazyHandler("v24_3_handlers", "handle_bounty_poc_generate"),
    "bounty.report_generate": LazyHandler("v24_3_handlers", "handle_bounty_report_generate"),
    "bounty.platforms": LazyHandler("v24_3_handlers", "handle_bounty_platforms"),
    "bounty.scan_platform": LazyHandler("v24_3_handlers", "handle_bounty_scan_platform"),
    "bounty.match": LazyHandler("v24_3_handlers", "handle_bounty_match"),
    "bounty.deadlines": LazyHandler("v24_3_handlers", "handle_bounty_deadlines"),
    "bounty.stats": LazyHandler("v24_3_handlers", "handle_bounty_stats"),
    "bounty.earnings": LazyHandler("v24_3_handlers", "handle_bounty_earnings"),
    "strata.model_security": LazyHandler("v24_3_handlers", "handle_strata_model_security"),
    "bounty.huntr_mfv": LazyHandler("v24_3_handlers", "handle_bounty_huntr_mfv"),
    "bounty.opportunities": LazyHandler("v24_3_handlers", "handle_bounty_opportunities"),
    "bounty.register_agent": LazyHandler("v24_3_handlers", "handle_bounty_register_agent"),
