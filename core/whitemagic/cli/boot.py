...
def register_all_commands(
    ...
    # 4. Hardware
    register_optional(
        main_group, "hardware", "whitemagic.cli.hardware_commands", "hardware"
    )
    ...
    register_optional(
        main_group,
        "autonomous",
        "whitemagic.cli.cli_autonomous_execution",
        "autonomous",
    )
    ...
    # 10. Cache
    register_optional(
        main_group, "cache", "whitemagic.cli.cli_cache", "cache_cli", cli_name="cache"
    )
    ...
    # 14. PRAT
    register_optional(
        main_group, "prat", "whitemagic.cli.cli_prat", "prat", cli_name="prat"
    )
    ...
    register_optional(
        main_group,
        "dream",
        "whitemagic.cli.commands.dream_commands",
        "dream_group",
        cli_name="dream",
    )
    ...
    register_optional(
        main_group,
        "self-improve",
        "whitemagic.cli.commands.self_improve_commands",
        "self_improve",
        cli_name="self-improve",
        warn_on_fail=True,
    )
