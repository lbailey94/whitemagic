...
MAJOR_ARCANA: list[MajorArcanaCard] = [
    MajorArcanaCard(
        ...
        hebrew_name="Aleph",
        hebrew_value=1,
        suares_meaning="Unthinkable pulsation of life-death; the abstract beat underlying all change",
        element="air",
        planet_or_sign="Uranus",
        alchemical_stage="pre-nigredo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Bet",
        hebrew_value=2,
        suares_meaning="Container principle; all dwellings and supports which frame existence",
        element="all",
        planet_or_sign="Mercury",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Gimel",
        hebrew_value=3,
        suares_meaning="Activating movement; the organic impetus that animates containers",
        element="water",
        planet_or_sign="Moon",
        alchemical_stage="nigredo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Dalet",
        hebrew_value=4,
        suares_meaning="Physical resistance; the inertia that gives structure and boundaries",
        element="earth",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="He",
        hebrew_value=5,
        suares_meaning="Universal life-force; the breath of vitality that infuses matter",
        element="fire",
        planet_or_sign="Aries",
        alchemical_stage="nigredo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Vav",
        hebrew_value=6,
        suares_meaning="Fertilizing link; the agent of impregnation that bridges life and form",
        element="earth",
        planet_or_sign="Taurus",
        alchemical_stage="nigredo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Zayin",
        hebrew_value=7,
        suares_meaning="Realized potential; the opening into possibility when form is achieved",
        element="air",
        planet_or_sign="Gemini",
        alchemical_stage="nigredo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Het",
        hebrew_value=8,
        suares_meaning="Primordial reservoir; the unstructured energy substratum of the cosmos",
        element="water",
        planet_or_sign="Cancer",
        alchemical_stage="nigredo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Tet",
        hebrew_value=9,
        suares_meaning="Primeval structure; the female principle building form from formless energy",
        element="fire",
        planet_or_sign="Leo",
        alchemical_stage="nigredo→albedo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Yod",
        hebrew_value=10,
        suares_meaning="Temporal existence; projection of the primal pulsation into continuity",
        element="earth",
        planet_or_sign="Virgo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Kaf",
        hebrew_value=20,
        suares_meaning="Receptive capacity; the hollow hand ready to receive and hold emergent forms",
        element="fire",
        planet_or_sign="Jupiter",
        alchemical_stage="albedo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Lammed",
        hebrew_value=30,
        suares_meaning="Connecting principle; the controlled mediator linking forces",
        element="air",
        planet_or_sign="Libra",
        alchemical_stage="albedo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Mem",
        hebrew_value=40,
        suares_meaning="Maternal medium; the waters of formation where life originates",
        element="water",
        planet_or_sign="Neptune",
        alchemical_stage="albedo",
        keywords=[
            "surrender",
            "new perspective",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Nun",
        hebrew_value=50,
        suares_meaning="Individual existence; the conditioned manifestation of universal life",
        element="water",
        planet_or_sign="Scorpio",
        alchemical_stage="albedo→cauda pavonis",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Samekh",
        hebrew_value=60,
        suares_meaning="Cyclical support; the female enclosure of fertility within repetition",
        element="fire",
        planet_or_sign="Sagittarius",
        alchemical_stage="cauda pavonis",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Ayin",
        hebrew_value=70,
        suares_meaning="Perceptive vision; the eye that sources and frames potential",
        element="earth",
        planet_or_sign="Capricorn",
        alchemical_stage="cauda pavonis",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Pe",
        hebrew_value=80,
        suares_meaning="Primal articulation; the channeling of undifferentiated energy",
        element="fire",
        planet_or_sign="Mars",
        alchemical_stage="cauda pavonis→rubedo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Tsadi",
        hebrew_value=90,
        suares_meaning="Evolutionary structuring; progression from simple cell to complex form",
        element="air",
        planet_or_sign="Aquarius",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Qof",
        hebrew_value=100,
        suares_meaning="Deathless transcendence; exalted pulsation that escapes temporal decay",
        element="water",
        planet_or_sign="Pisces",
        alchemical_stage="rubedo",
        keywords=[
            "illusion",
            "fear",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Resh",
        hebrew_value=200,
        suares_meaning="Cosmic container; the star-strewn dwelling holding all existence",
        element="fire",
        planet_or_sign="Sun",
        alchemical_stage="rubedo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Shin",
        hebrew_value=300,
        suares_meaning="Spirit-breath; the prodigious motion animating every organism",
        element="fire",
        planet_or_sign="Pluto",
        alchemical_stage="rubedo",
    ...
    MajorArcanaCard(
        ...
        hebrew_name="Tav",
        hebrew_value=400,
        suares_meaning="Structural limit; the resistance that enables form to emerge",
        element="earth",
        planet_or_sign="Saturn",
        alchemical_stage="rubedo→completion",
        keywords=[
            "completion",
            "wholeness",
            "integration",
...
_MINOR_MEANINGS: dict[str, dict[str, tuple[str, str, str]]] = {
    "wands": {
        ...
        "two": (
            "planning, deciding direction",
            "making choices about the future",
            "fear of commitment",
        ),
        "three": (
            "expansion, forward movement",
            "progress and growth",
            "delays, obstacles to growth",
        ),
        "four": (
            "celebration, stability",
            "harmony and achievement",
            "instability, disrupted peace",
        ),
        "five": (
            "conflict, competition",
            "healthy rivalry, striving",
        ...
        "seven": (
            "defiance, standing one's ground",
            "defending position with courage",
            "yielding, giving up",
        ),
        "eight": (
            "speed, swift action",
            "rapid progress, momentum",
            "frustration, delays",
        ),
        "nine": (
            "resilience, last stand",
        ...
        "ten": (
            ...
            "overwhelm, unable to carry the load",
        ),
        "page": (
            "messenger of fire",
            "new creative opportunity, enthusiasm",
            "delayed news, lack of direction",
        ),
        "knight": (
            "quest for inspiration",
            "adventurous, passionate pursuit",
        ...
        "king": (
            "mastery of will",
            "charismatic, visionary authority",
            "tyranny, domineering",
        ),
    },
    "cups": {
        "ace": (
            "overflowing emotion",
            "new love or emotional beginning",
            "blocked emotions, emptiness",
        ),
        "two": (
            "partnership, connection",
            "mutual attraction, harmony",
            "imbalance, broken trust",
        ),
        "three": (
            "celebration, friendship",
            "joyful community, abundance",
            "isolation, social conflict",
        ),
        "four": (
            "boredom, apathy",
            "contemplating new options",
            "missed opportunity, awareness returning",
        ),
        "five": (
            "loss, grief",
        ...
        "six": (
            "nostalgia, childhood",
            "innocent joy, memories",
            "clinging to the past",
        ),
        "seven": (
            "illusion, choices",
            "many options, dreamlike state",
            "clarity, making a grounded choice",
        ),
        "eight": (
            "walking away",
            "leaving what no longer serves",
            "fear of leaving, staying stuck",
        ),
        "nine": (
            "emotional fulfillment",
            "contentment, self-love",
            "dissatisfaction, smugness",
        ),
        "ten": (
            "perfect happiness",
            "emotional completion, family",
            "misalignment of values",
        ),
        "page": (
            "messenger of water",
            "new emotional opportunity, intuition",
            "emotional immaturity, moodiness",
        ),
        "knight": (
            "quest for love",
            "romantic, idealistic pursuit",
            "unrealistic expectations, moodiness",
        ),
        "queen": (
            "mastery of heart",
            "compassionate, intuitive leadership",
            "emotional dependence, insecurity",
        ),
        "king": (
            "mastery of emotion",
            "diplomatic, balanced authority",
            "manipulation, emotional withdrawal",
        ),
    },
    "swords": {
        "ace": (
            "clarity of mind",
            "breakthrough, sharp insight",
            "confusion, clouded judgment",
        ),
        "two": (
            "difficult choice, stalemate",
            "balanced decision, truce",
            "indecision, information withheld",
        ),
        "three": (
            "heartbreak, sorrow",
            "processing painful truth",
            "recovery from grief, healing",
        ),
        "four": (
            "rest, recovery",
            "needed pause, convalescence",
            "restlessness, forced rest",
        ),
        "five": (
            "conflict, defeat",
            "hollow victory, loss",
            "reconciliation, moving past conflict",
        ),
        "six": (
            "transition, moving away",
            "leaving troubles behind",
            "resistance to change, carrying baggage",
        ),
        "seven": (
            "strategy, deception",
            "clever planning, indirect approach",
            "exposure, confession",
        ),
        "eight": (
            "entrapment, self-limitation",
            "feeling trapped by thoughts",
            "release from mental prison",
        ),
        "nine": (
            "anxiety, worry",
            "sleepless nights, fear",
            "recovery from anxiety, hope",
        ),
        "ten": (
            "painful ending, betrayal",
            "rock bottom, the end of suffering",
            "recovery, survival, the worst is over",
        ),
        "page": (
            "messenger of air",
            "new idea, curiosity, vigilance",
            "miscommunication, gossip",
        ),
        "knight": (
            "quest for truth",
            "driven, intellectual pursuit",
            "aggression, dogmatism",
        ),
        "queen": (
            "mastery of mind",
        ...
        "king": (
            ...
            "authoritative, fair, decisive",
            "manipulation, tyranny of reason",
        ),
    },
    "pentacles": {
        "ace": (
            "new opportunity",
            "prosperity, material beginning",
            "missed opportunity, lack",
        ),
        "two": (
            "juggling resources",
        ...
        "three": (
            "collaboration, craft",
            "teamwork, skilled work",
            "lack of recognition, poor quality",
        ),
        "four": (
            "stability, holding",
        ...
        "five": (
            "hardship, scarcity",
            "material difficulty, feeling left out",
            "recovery, improvement",
        ),
        "six": (
            "generosity, giving",
            "sharing resources, charity",
            "inequality, strings attached",
        ),
        "seven": (
            "assessment, patience",
            "evaluating progress, waiting for results",
            "impatience, poor investment",
        ),
        "eight": (
            "dedication, skill",
            "mastery through practice, craftsmanship",
            "lack of focus, mediocrity",
        ),
        "nine": (
            "abundance, self-sufficiency",
            "financial independence, enjoyment",
            "overwork, false wealth",
        ),
        "ten": (
            "legacy, family wealth",
            "generational success, security",
            "financial loss, family disputes",
        ),
        "page": (
            "messenger of earth",
            "new opportunity, studiousness",
            "lack of progress, laziness",
        ),
        "knight": (
            "quest for prosperity",
            "patient, reliable, hardworking",
            "stagnation, stubbornness",
        ),
        "queen": (
            "mastery of resources",
            "nurturing, practical, abundant",
            "selfishness, insecurity about resources",
        ),
        "king": (
            "mastery of matter",
            "wealthy, successful, generous",
            "greed, materialism, control",
        ),
    },
}
...
FIXED_SIGN_TETRAMORPH: dict[str, dict[str, str]] = {
    "aquarius": {
        "element": "air",
        "tool": "cup",
        "teaching": "Mind can flow like water when aired-out",
    },
    "leo": {
        "element": "fire",
        "tool": "wand",
        "teaching": "Will must learn to rest, not burn itself out",
    },
    "scorpio": {
        "element": "water",
        "tool": "sword",
        "teaching": "Intellect becomes vision once passions transmute",
    },
    "taurus": {
        "element": "earth",
        "tool": "pentacle",
        "teaching": "Stable form holds all other forces",
    },
}
