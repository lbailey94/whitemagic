...
def get_all_ganas() -> list[BaseGana]:
    ...
    return [
        cast("BaseGana", HornGana()),
        cast("BaseGana", NeckGana()),
        cast("BaseGana", RootGana()),
        cast("BaseGana", RoomGana()),
        cast("BaseGana", HeartGana()),
        cast("BaseGana", TailGana()),
        cast("BaseGana", WinnowingBasketGana()),
        cast("BaseGana", GhostGana()),
        cast("BaseGana", WillowGana()),
        cast("BaseGana", StarGana()),
        cast("BaseGana", ExtendedNetGana()),
        cast("BaseGana", WingsGana()),
        cast("BaseGana", ChariotGana()),
        cast("BaseGana", AbundanceGana()),
        cast("BaseGana", StraddlingLegsGana()),
        cast("BaseGana", MoundGana()),
        cast("BaseGana", StomachGana()),
        cast("BaseGana", HairyHeadGana()),
        cast("BaseGana", NetGana()),
        cast("BaseGana", TurtleBeakGana()),
        cast("BaseGana", ThreeStarsGana()),
        cast("BaseGana", DipperGana()),
        cast("BaseGana", OxGana()),
        cast("BaseGana", GirlGana()),
        cast("BaseGana", VoidGana()),
        cast("BaseGana", RoofGana()),
        cast("BaseGana", EncampmentGana()),
