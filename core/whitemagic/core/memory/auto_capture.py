...
class MemoryCapture:
    ...
    def __init__(self, base_dir: Path | None = None, frequency: int = 5):
        """
    ...
    def capture_memory(self, force: bool = False) -> None:
        """
    ...
    def _save_memory(self, memory: ShortTermMemory) -> None:
        """Save memory to file."""
...
_capture_instance: MemoryCapture | None = None


def get_capture(frequency: int | None = None) -> MemoryCapture:
...
def record_action(action_type: str, description: str, **kwargs: Any) -> None:
