...
GARDEN_GANA_REGISTRY: list[GardenGanaMapping] = [
    GardenGanaMapping(
        ...
        description="Session Initialization - The spark of curiosity",
    ...
    GardenGanaMapping(
        ...
        description="Stability/Memory - The pause that grounds",
    ...
    GardenGanaMapping(
        ...
        primary_emotion="Love",
        description="Session Context - The emotional center",
    ...
    GardenGanaMapping(
        ...
        quadrant=Quadrant.NORTHERN,
        element=Element.FIRE,
        primary_emotion="Truth",
        description="Governance/Strategy - Right action",
    ...
    GardenGanaMapping(
        ...
        element=Element.EARTH,
        primary_emotion="Truth",
        description="Boundaries/Alerts - Clear limits",
        resonance_keywords=["truth", "boundary", "limit", "alert", "verify"],
    ),
    GardenGanaMapping(
        garden="awe",
        gana="Straddling Legs (Kui)",
        gana_tool="gana_straddling_legs",
        quadrant=Quadrant.WESTERN,
    ...
    GardenGanaMapping(
        garden="practice",
        gana="Turtle Beak (Zui)",
        gana_tool="gana_turtle_beak",
        quadrant=Quadrant.WESTERN,
        element=Element.METAL,
        primary_emotion="Courage",
        secondary_emotion="Wisdom",
    ...
    GardenGanaMapping(
        ...
        quadrant=Quadrant.SOUTHERN,
        element=Element.FIRE,
        primary_emotion="Joy",
        description="Regeneration/Surplus - Overflowing happiness",
...
def get_by_emotion(emotion: str) -> list[GardenGanaMapping]:
    ...
    return [
        e for e in GARDEN_GANA_REGISTRY if e.primary_emotion.lower() == emotion.lower()
    ]
