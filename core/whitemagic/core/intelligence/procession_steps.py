...
YIN_PROCESSION: list[ProcessionStep] = [
    ...
    ProcessionStep(
        ...
        ripley_gate="Separation",
        color_stage="Nigredo->Cauda Pavonis",
        wu_xing="earth",
        modality="cardinal",
        is_fixed=False,
        is_checkpoint=False,
    ...
    ProcessionStep(
        ...
        ripley_gate="Conjunction",
        color_stage="Cauda Pavonis",
        wu_xing="wood",
        modality="mutable",
        is_fixed=False,
        is_checkpoint=False,
        ...
        yang_tool="rabbit_hole_research",
        yin_tool="association.mine",
    ),
    ProcessionStep(
        step_number=5,
        sign="scorpio",
        ...
        operation="Emergence",
        ripley_gate="Putrefaction",
        color_stage="Cauda Pavonis->Albedo",
        wu_xing="water",
        modality="fixed",
        is_fixed=True,
        is_checkpoint=True,
    ...
    ProcessionStep(
        ...
        ripley_gate="Sublimation",
        color_stage="Albedo->Citrinitas",
        wu_xing="fire",
        modality="fixed",
        is_fixed=True,
        is_checkpoint=True,
        ...
        yang_tool="codegenome.generate",
        yin_tool="ensemble.query",
    ),
    ProcessionStep(
        step_number=9,
        sign="cancer",
        ...
        ripley_gate="Fermentation",
        color_stage="Citrinitas",
        wu_xing="water",
        modality="cardinal",
        is_fixed=False,
        is_checkpoint=False,
    ...
    ProcessionStep(
        ...
        operation="Grounding",
        ripley_gate="Multiplication",
        color_stage="Citrinitas->Rubedo",
        wu_xing="earth",
        modality="fixed",
        is_fixed=True,
        is_checkpoint=True,
