...
def safe_rust_call(func_name: str, args: dict[str, Any]) -> Any | None:
    """Safely call a Rust function by name with error handling.

    Args:
        func_name: Name of the Rust function to call
