...
async def main():
    logger.debug("=== Verifying Northern Quadrant Ganas ===")

    # 1. Dipper (Governance / Deep Search)
    await run_test(
        "Dipper (Search)", gana_dipper, task="search_memories", query="test", limit=3
    )
