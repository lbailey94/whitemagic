...
def generate_report(results: list[BenchmarkResult], concurrent_results: dict) -> str:
    ...
    # Summary table
    report.append("\n## Summary\n")
    report.append("| Tool | Median (ms) | P95 (ms) | P99 (ms) | Success Rate | Memory (MB) |")
    report.append("|------|-------------|----------|----------|--------------|-------------|")
    ...
    if concurrent_results:
        ...
        report.append("| Concurrency | Requests | Successes | Throughput (req/s) | Success Rate |")
        report.append("|-------------|----------|-----------|-------------------|--------------|")
...
def main():
    ...
    parser.add_argument("--concurrent", action="store_true",
                       help="Run concurrent load tests")
