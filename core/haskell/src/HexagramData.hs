...
hexagramTable = Map.fromList
    ...
    , (14, HexagramInfo "大有" "Da You" "Great Possession. Fire above heaven. Abundance and recognition; handle power with generosity and grace.")
    ...
    , (25, HexagramInfo "無妄" "Wu Wang" "Innocence. Heaven above thunder. Act from pure intention; sincerity brings unexpected fortune.")
    , (26, HexagramInfo "大畜" "Da Xu" "Great Accumulation. Mountain above heaven. Contain and nourish power; the mountain holds the sky.")
    , (27, HexagramInfo "頤" "Yi"    "Nourishment. Mountain above thunder. Attend to what you feed: body, mind, and others.")
    ...
    , (35, HexagramInfo "晉" "Jin"   "Progress. Fire above earth. Steady advancement into the light; conditions favor forward movement.")
    ...
    , (43, HexagramInfo "夬" "Guai"  "Breakthrough. Lake above heaven. Decisive action resolves long-standing tension; speak truth.")
