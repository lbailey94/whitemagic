...
echo "  • MemoryStore      — In-browser memory CRUD + search + export/import"
echo "  • DharmaEngine     — Browser-local governance with safety rules"
echo "  • KarmaLedger      — Append-only karma tracking"
echo "  • GnosisSnapshot   — System self-awareness summary"
echo "  • cosine_similarity() / batch_similarity() — Vector operations"
echo "  • text_search()    — Full-text search"
echo "  • quick_infer()    — One-shot inference function"
echo "  • wasm_ready()     — Health check"
echo "  • wasm_version()   — Version info"
echo ""
echo "Next steps:"
echo "  1. Import in browser: import init, { MemoryStore, DharmaEngine, KarmaLedger, EdgeEngine, gnosis_snapshot } from './pkg/web/whitemagic_rs.js'"
