...
[![Version](https://img.shields.io/badge/version-25.2.0-purple.svg)](core/VERSION)
[![PyPI](https://img.shields.io/pypi/v/whitemagic)](https://pypi.org/project/whitemagic/)

**v25.2.0** — **860 callable tools** · **28 Gana meta-tools** · **14-galaxy memory** · **Dharma governance** · **Citta stream** · **MandalaOS compartments** · **7-language polyglot acceleration** · **Violet security pipeline**
