...
class TestDreamPhaseSerendipity:
    ...
    @pytest.mark.asyncio
    async def test_serendipity_phase_graceful(self):
...
class TestDreamCycleE2E:
    ...
    @pytest.mark.asyncio
    async def test_status_reflects_history(self):
        dc = DreamCycle()
        await dc._run_phase()
        await dc._run_phase()
    ...
    async def test_consolidation_with_mock_memories_and_galactic_promotion(self):
        ...
        with patch(
            ...
            await dc._run_phase()  # CONSOLIDATION
    ...
    @pytest.mark.asyncio
    async def test_all_reports_json_serializable(self):
